...
public class PMSFolioService {
	...
	public List<PMSFolioGuestModel> getListGuestForFolio(String folionum) {
		return pmsFolioDao.getListGuestForFolio(ConvertUtil
				.convertToInteger(folionum));
	}
	...
	public int deleteMessageFolio(String folionum, String messId) {
		return pmsFolioDao.deleteMessage(
				ConvertUtil.convertToInteger(folionum),
				ConvertUtil.convertToInteger(messId));
	}
