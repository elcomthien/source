...
public class CoreMedia extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Ip: " + ipClient + " - keystb: " + keystb + " - lenh : " + lenh);
		...
		if (lenh == Command.com_getlang) {
			...
			System.out.println("Ip: " + ipClient + " - In setKeyStbIntoRoom(" + keystb + "," + room + ")");
		...
		if (lenh == Command.com_getFilmCode) {
			System.out.println("Ip: " + ipClient + " - In com_getFilmCode(" + keystb + ")");
		...
		if (lenh == Command.com_getlistfileofsubject) {
			...
			System.out.println("Ip: " + ipClient + " - In getMODCtnIDsOfSubjectNew(" + keystb + "," + subjectid + "," + fromRow + ","
					+ noRows + ")");
