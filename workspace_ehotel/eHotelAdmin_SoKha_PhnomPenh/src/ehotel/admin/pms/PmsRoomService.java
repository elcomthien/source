...
/**
 * Servlet implementation class PmsRoomService
 */
public class PmsRoomService extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private PMSServiceDBI pmsServiceDBI = new PMSServiceDBI();

	public PmsRoomService() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsRoomService.jsp");
		...
		case 1:// list subject
		{
			...
			String st = pmsServiceDBI.getSubject(LangID, 101);
			out.print(st);
			break;
		}
		case 5:// list subject left
		{
			...
			response.setContentType("text/xml");
			String str = pmsServiceDBI.getSuboutHotel(id, LangID, 101);
			out.print(str);
			break;
		}
		case 6:// list subject right
		{
			...
			response.setContentType("text/xml");
			String str = pmsServiceDBI.getSubinHotel(id, LangID, 101);
			out.print(str);
			break;
		}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 1:// insert pms subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				int id = pmsServiceDBI.addMenuService(menu, 101);
