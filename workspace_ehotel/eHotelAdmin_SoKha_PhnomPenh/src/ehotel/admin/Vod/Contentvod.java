...
public class Contentvod extends ServiceParent {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case 10:// add subtitle
		{
			...
			while (request.getParameter("name" + i) != null) {
				...
				String type = "";
				if (ipserver.equals("192.168.99.8"))
					type = "/8";
				else if (ipserver.equals("192.168.99.12"))
					type = "/12";
	...
	public int addVod(int subjId, Vod vod) {
		int seq = -1;
		int storageid = 1;
		String ipserver = "192.168.99.2";
		int mem2 = getMemoryUsage();
		int mem8 = getHDD8();
		int mem12 = getHDD12();
		if (mem2 > 95) {
			if (mem8 < 95) {
				ipserver = "192.168.99.8";
			} else {
				if (mem12 < 95) {
					ipserver = "192.168.99.12";
				} else {
					return -1;
				}
			}
	...
	public int getHDD8() {
		...
		try {
			JSch jsch = new JSch();
			Session session = jsch.getSession("root", "192.168.99.8", 22);
	...
	public int getHDD12() {
		...
		try {
			JSch jsch = new JSch();
			Session session = jsch.getSession("root", "192.168.99.12", 22);
			session.setPassword("sokha#@");
			Properties config = new Properties();
			config.put("StrictHostKeyChecking", "no");
			session.setConfig(config);
