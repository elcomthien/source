...
public class ModSrvMain extends ServiceParent {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case 1:///insert subject
		{
			...
			{								
				...
				//ko can sua cho nay vi luu db chi co ten ko luu du thua du lieu 18.1
		...
		case 3://update song 
		{
			...
			if(request.getParameter("name")!=null)
			{
				...
				System.out.println("title2 = = = = = " + UnicodeConverter.decodeUnicode(title));
				System.out.println("title3 = = = = = " + UnicodeConverter.encodeUnicode(title));
	...
	private String getContentMp3(int subjId,int index,int page)
	{
		...
		{			
			...
			mData+="</Singer>";
			mData+="<url>";
			mData+="<![CDATA["+srvMod.getModInfo(item.getId(), LangID).getUrl()+"]]>";
			mData+="</url>";
			mData+="<lyric>";
