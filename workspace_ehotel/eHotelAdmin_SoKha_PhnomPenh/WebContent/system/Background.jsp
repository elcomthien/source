...
<div style="width: 1024;" >
	<div>
		<div class="left_content_top" style="margin-left: 0px;">Welcome Music Manager</div>
		<div class="left_content_bottom" style="margin-bottom: 20px;">
			<div class="grid">
				<div class="grid_header">
					...
					<div class="tab_menu" id="tab_menu" style="float: right; width: 130px;">
						<div class="tab_menu_item" id="0"
				...
				<div class="grid_center">
					<div id="id_table" style="height: auto; display: none;"></div>
					<div id="id_table_bg_video" style="height: 350px;"></div>
