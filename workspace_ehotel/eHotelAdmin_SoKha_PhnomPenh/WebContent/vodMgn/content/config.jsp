							...
							<div class="grid">
								...
								<div class="grid_center">
									<div id="content_config"
										...
										<div class="row">
											<div class="span2"
												style="text-align: right; margin-top: 25px;"><%=readerLang.getContent("hostftp")%>:</div>
										...
										<div class="row" style="margin-top: 10px;">
											<div class="span2"
												style="text-align: right; margin-top: 5px;"><%=readerLang.getContent("portftp")%>:</div>
											<div class="span3">
										...
										<div class="row" style="margin-top: 10px;">
											<div class="span2"
												style="text-align: right; margin-top: 5px;"><%=readerLang.getContent("userftp")%>:</div>
											<div class="span3">
										...
										<div class="row" style="margin-top: 10px;">
											<div class="span2"
												style="text-align: right; margin-top: 5px;"><%=readerLang.getContent("passftp")%>:</div>
											<div class="span3">
										...
										<div class="row" style="margin-top: 20px; margin-left: 30px;">
											...
											<input type="button" value=" <%=readerLang.getContent("config")%> " class="div_buton" id="cfbtnconfig"  onclick="config()" style="float: right; width: 100px;" />
<!-- 												<button class="btn btn-primary" style="width: 100px" id="cfbtnconfig"  onclick="config()" > Config</button> -->
											...
											<input type="button" value=" <%=readerLang.getContent("reset")%>" class="div_buton" id="cfbtnreset" onclick="reset()" style="width: 100px; margin-left: 0px;"/>
