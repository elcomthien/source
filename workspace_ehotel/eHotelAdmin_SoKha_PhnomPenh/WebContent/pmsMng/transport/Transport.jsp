...
<script type="text/javascript" src="../javascript/pms/transport.js"></script>
<%@ include file="../../include/ParamterPms.jsp"%>
<div style="width: 1024;">
	<div class="left_content">
		<div class="left_content_top">
			<%=readerLang.getContent("TransportationMgn") %>
		</div>
				...
				<div class="grid_header">
					...
					<div style="float: right; width: 150px;" class="tab_menu"
						...
						<div class="tab_menu_item_sel" id="1"
							...
							<p style="margin-top: 5px; height: 0px;"><%=readerLang.getContent("Transport")%></p>
						</div>
					</div>
				</div>
				<div class="grid_center">
					<div id="id_table" style="height: auto; min-height: 350;">
					</div>
				</div>
