...
function subject() {
	...
	ctMenu.funchange = function() {
		my.statussubject(this.obj);
	};
	var my = this;
	this.divName = "menu";
	var _row = 0;
...
//	};
	...
	this.statussubject = function(obj) {
