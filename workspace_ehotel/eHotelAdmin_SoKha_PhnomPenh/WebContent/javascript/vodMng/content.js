...
function subjectVod() {
	...
	this.get = function() {
		...
		f.complet = function(tx) {
			...
			if(arr.length == 0)
				$("div_linkadd").style.display="block";
			my.List = arr;
			menu.load(arr);
...
function Subtitle(id) {
	...
	this.createSelect = function(lang) {
		...
		var newOpt7 = new Option("Khmer", 7);
		var newOpt2 = new Option("VietNam", 1);
		var newOpt8 = new Option("Thailand", 8);
		var newOpt3 = new Option("Chinese", 3);
		var newOpt4 = new Option("Korean", 4);
		var newOpt5 = new Option("Japanese", 5);
		var newOpt6 = new Option("French", 6);
