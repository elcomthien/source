...
public class SystemService {
	...
	public HashMap<String, String> getMessageOrder() {
		return systemDao.getMessageOrder();
	}
	
	public int updateMessageOrder(String messvn, String messen, String start, String stop) {
		messvn = UnicodeConverter.encodeUnicode(messvn);
		messen = UnicodeConverter.encodeUnicode(messen);
		return systemDao.updateMessageOrder(messvn, messen, start, stop);
	}
}
