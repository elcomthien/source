...
public class SQL {
	...
	public static final String GET_MESSAGE_ORDER = "BEGIN EMAIN.getMessageOrder(?); END;";
	public static final String UPDATE_MESSAGE_ORDER= "BEGIN EMAIN.updateMessageOrder(?,?,?,?,?); END;";
