...
public class SystemController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("getmessageorder")) {
			LogUtil.logControl(SystemController.class.toString(), "getmessageorder", "none");

			HashMap<String, String> hmap = new HashMap<String, String>();
			hmap = systemService.getMessageOrder();
			response.getWriter().write(new Gson().toJson(hmap));
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("updatemessageorder")) {
			String messvn = request.getParameter("message_vn");
			String messen = request.getParameter("message_en");
			String start = request.getParameter("start_time");
			String stop = request.getParameter("stop_time");

			LogUtil.logControl(SystemController.class.toString(), "updatemessageorder", "messvn,,," + messvn + ",,,messen,,," + messen
					+ ",,,start,,," + start + ",,,stop,,," + stop);

			int rs = systemService.updateMessageOrder(messvn, messen, start, stop);
			out.println(rs);
		}
