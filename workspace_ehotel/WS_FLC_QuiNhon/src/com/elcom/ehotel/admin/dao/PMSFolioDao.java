...
public class PMSFolioDao {
	...
	public List<HashMap<String, String>> getSmartcardFolio(String folionum) {
		...
		LogUtil.logDao(PMSFolioDao.class.toString(), SQL.GET_SMARTCARD_FOLIO, params, "folioNum", outParam.size() / 3);
		for (int i = 0; i < outParam.size(); i = i + 3) {
			HashMap<String, String> hmap = new HashMap<String, String>();
			hmap.put("serinumber", outParam.get(i));
			hmap.put("idaddress", outParam.get(i + 1));
			hmap.put("status", outParam.get(i + 2));
			list.add(hmap);
		}
		return list;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(p.getListOrder("1703","28/08/2017","31/08/2017"));
	}
}
