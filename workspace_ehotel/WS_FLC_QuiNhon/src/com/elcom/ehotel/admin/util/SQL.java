...
public class SQL {
	...
	public static final String GET_CHANNEL_VIEW = "BEGIN ELIVETV.getChannelView(?,?,?); END;";
	...
	// livetivi channel advertise
	public static final String GET_LIST_VIDEO = "BEGIN ELIVETV.getListVideo(?); END;";
	public static final String ADD_VIDEO = "BEGIN ELIVETV.addVideo(?,?,?,?); END;";
	public static final String EDIT_VIDEO = "BEGIN ELIVETV.editVideo(?,?,?,?,?,?); END;";
	public static final String DELETE_VIDEO = "BEGIN ELIVETV.deleteVideo(?,?); END;";
