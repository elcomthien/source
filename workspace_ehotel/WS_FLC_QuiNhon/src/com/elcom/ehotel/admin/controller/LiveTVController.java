...
public class LiveTVController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (action.equals("getlistsubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"getlistsubject", "langId,,," + langId);

			List<LiveTVSubjectModel> list = new ArrayList<LiveTVSubjectModel>();
			list = liveTVService.getListSubjectLiveTV(ConvertUtil
					.convertToInteger(langId));
		...
		if (action.equals("getlistchannel")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"getlistchannel", "idsubject,,," + idSubject);

			List<LiveTVChannelModel> list = new ArrayList<LiveTVChannelModel>();
			list = liveTVService.getListChannel(ConvertUtil
					.convertToInteger(idSubject));
		...
		if (action.equals("getvideo")) {
			LogUtil.logControl(LiveTVController.class.toString(), "getvideo",
					"none");

			List<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
			list = liveTVService.getListVideo();

			response.getWriter().write(new Gson().toJson(list));
		}

		if (action.equals("getchannelview")) {
			String from = request.getParameter("from_date");
			String to = request.getParameter("to_date");
			LogUtil.logControl(LiveTVController.class.toString(),
					"getchannelview", "from,,," + from + ",,,to,,," + to);

			List<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
			list = liveTVService.getChannelView(from, to);
	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("addnewsubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"addnewsubject", "name,,," + name + ",,,image,,," + image
							+ ",,,status,,," + status + ",,,listadd,,,"
							+ listadd);
		...
		if (action.equals("editsubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"editsubject", "idsubject,,," + id + ",,,name,,," + name
							+ ",,,image,,," + image + ",,,status,,," + status
							+ ",,,listadd,,," + listadd + ",,,listremove,,,"
							+ listremove);
		...
		if (action.equals("deletesubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"deletesubject", "idSubject,,," + idSubject);

			int rs = liveTVService.deleteSubjcetLiveTV(ConvertUtil
					.convertToInteger(idSubject));
			out.println(rs);
		}
		...
		if (action.equals("addnewchannel")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"addnewchannel", "idsubject,,," + idSubject + ",,,name,,,"
							+ name + ",,,index,,," + index + ",,,link,,,"
							+ link + ",,,image,,," + image + ",,,status,,,"
		...
		if (action.equals("editchannel")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"editchannel", "idChannel,,," + idChannel + ",,,name,,,"
							+ name + ",,,index,,," + index + ",,,link,,,"
							+ link + ",,,image,,," + image + ",,,status,,,"
							+ status + ",,,language,,," + language
							+ ",,,subtitle,,," + subtitle);
		...
		if (action.equals("deletechannel")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"deletechannel", "idChannel,,," + idChannel);

			int rs = liveTVService.deleteChannel(ConvertUtil
					.convertToInteger(idChannel));
			out.println(rs);
		}
		...
		if (action.equals("addchanneladvertise")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"addchanneladvertise", "name,,," + name + ",,,filename,,,"
							+ filename + ",,,image,,," + image + ",,,status,,,"
							+ status);
		...
		if (action.equals("editchanneladvertise")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"editchanneladvertise", "channelId,,," + channelId
		...
		if (action.equals("deletechanneladvertise")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(),
					"deletechanneladvertise", "channelId,,," + channelId);
		...
		if (action.equals("addvideo")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "addvideo",
					"name,,," + name + ",,,url,,," + url + ",,,status,,,"
							+ status);

			int rs = liveTVService.addVideo(name, url, status);
			out.println(rs);
		}

		if (action.equals("editvideo")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "editvideo",
					"id,,," + id + ",,,name,,," + name + ",,,url,,," + url
							+ ",,,status,,," + status + ",,,index,,," + index);

			int rs = liveTVService.editVideo(id, name, url, status, index);
			out.println(rs);
		}
		...
		if (action.equals("deletevideo")) {
			...
			int rs = liveTVService.deleteVideo(id);
			out.println(rs);
		}
