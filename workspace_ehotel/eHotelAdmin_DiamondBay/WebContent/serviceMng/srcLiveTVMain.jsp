...
<script type="text/javascript"
	src="../javascript/service/srcLiveTVMain.js"></script>
			...
			<div class="grid">
				<div class="grid_header" style="">
					<span
						...
						id="title_subject"><div style="font-size: 18px" id="totalUser"></div> </span>
					<div class="tab_menu" id="tab_menu" style="float: right; width: 330px;">
						...
						<div class="tab_menu_item" id="1" onclick="changeTab(this.id);" ><!-- style="visibility: hidden" -->
							<p style="margin-top: 5px; height: 0px;"><%=readerLang.getContent("9") %></p>
						</div>
						<div class="tab_menu_item" id="2" onclick="changeTab(this.id);">
							<p style="margin-top: 5px; height: 0px;">Channels
<%-- 							<%=readerLang.getContent("channel") %> --%>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="grid_center">
					<div id="frmSearch" style="margin-left: 10px; display: block"
						align="left">
					...
					<div id="id_table2" style="height: auto; min-height: 330px; display: none;">
					</div>
					<div id="id_table1"
	...
	<div class="content_right" align="center" style="height: auto;">
		<div class="menu" style="margin-top: 25px" id="menu">
			<div class="menu_header">
				<div id="div_subject" style="float: left; color: white; font-size: 20px; margin-left: 20px; margin-top: 15px; font-weight: bold;">
					<%=readerLang.getContent("Subject") %>
				</div>
			</div>
			<div class="menu_center" align="center">
				<div id="menutree"></div>
				<div id="list_channel"></div>
