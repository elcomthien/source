...
<div class="" id="formTrailer">
	...
	<div style="float: left; width: 100%; text-align: left; height: 25px; margin-top: 10px;">
		<div style="float: left; width: 80px; color: #878888; margin-left: 10px;">File name:
<%-- 					<%=readerLang.getContent("filename")%>: --%>
	...
	<div style="width: 350px; height: auto; float: right; margin-top: -285px;">
			<div style="float: left; margin-top: 0px;">Logo image
<%-- 			<%=readerLang.getContent("logocn")%> --%>
			</div>
			...
			<div class="div_row_right_ctn" style="margin-top: 20px;">
				<div class="div_left_ctnadd" style="width: 90px;">Browse logo
...
<%-- 				<%=readerLang.getContent("channelname")%>: --%>
				</div>
...
<%-- 			value='<%=readerLang.getContent("addchannel")%>' --%>
			 class='div_buton' id="ctn_button_ok" style="width: 90px;">
			<input type="button" value='Reset'
<%-- 			 value='<%=readerLang.getContent("reset")%>' --%>
			  class='div_buton' id="ctn_button_Cancel" style="width: 90px;">
		</div>
