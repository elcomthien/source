...
<!-- 			</div> -->
<!-- 			---- -->
<!-- <iframe class='frame_upload' src="http://10.206.3.5:8888/Promotion/564.html" style='float: left;'
						valign="top" align="left" scrolling="no" frameborder='0'
						width="100%" height="40px"></iframe> -->
			<div class='pms_textbox_input' style='margin-top: 8px;'>
				...
				<input type="text" size='26' style='border: 1px solid #dddddd; height: 24; float: left; width: 190px; margin-top: 5px;'
						name="nameFile" id="nameFile" readonly="readonly"/>
...
<!-- 				</div> -->
	...
	<div
		style="float: right; margin-right: 10px; border: 0px solid #dddddd; width: 400px;height:350px; margin-top: 20px;">
		<div>
		 <iframe id="url_web" name="url_web" src="<%=url %>" style="width: 100%;height: 350px;"></iframe> 
		</div>
