...
<script type="text/javascript" src="../javascript/pms/Attaction.js"></script>
...
<script type="text/javascript"
	src="../javascript/pms/activiti_attraction.js"></script>
<%@ include file="../../include/ParamterPms.jsp"%>
<div style="width: 1024;">
	<div class="left_content">
		<div class="left_content_top">
			<%=readerLang.getContent("Attration-ActivitiesMgn") %>
		</div>
				...
				<div class="grid_header">
					...
					<div style="float: right;" class="tab_menu" id="tab_menu">
						<div class="tab_menu_item_sel" id="0"
							onclick="Main.changeTab(this.id);">
							<p style="margin-top: 5px; height: 20px;"><%=readerLang.getContent("Activites") %></p>
						</div>
						<div class="tab_menu_item" id="1"
							onclick="Main.changeTab(this.id);">
							<p style="margin-top: 5px; height: 0px;"><%=readerLang.getContent("Attractions") %></p>
						</div>
					</div>
				</div>
	...
	<div class="content_right" align="center">
		<div class="menu" style="margin-top: 25px;" id="menu">
			...
			<div class="menu_center" align="center">
				<div id='menutree'></div>
				<div>
					<a href="javascript:acti.sub.addSubject(-1);" class="div_addeImage"
						id="div_addeSubject"> <%=readerLang.getContent("AddSubject") %>
					</a>
				</div>
			</div>
