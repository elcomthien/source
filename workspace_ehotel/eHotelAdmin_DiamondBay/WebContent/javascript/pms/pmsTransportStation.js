...
function subject() {
	...
	ctMenu.fucchangestatus = function() {
		...
		var url = "TransportStationPms?CMD=10";
		url += "&subid=" + id;
		url += "&invisible=" + invi;
		url += "&t=" + Math.random();
	...
	this.addSubject = function(id) {
		...
		textbox.accept = function(value, image1, image2) {
			...
			this.hide();
			var url = "TransportStationPms?CMD=1";
			url += "&image1=" + image1;
			url += "&image2=" + image2;
			url += "&t=" + Math.random();
	...
	this.deletesubject = function(id) {
		...
		cfBox.accept = function() {
			var url = "TransportStationPms?CMD=3";
			url += "&SubId=" + id;
			url += "&t=" + Math.random();
	...
	this.editsubject = function(id) {
		...
		textbox.accept = function(value, image1, image2) {
			...
			image2 = image2.substring(image2.lastIndexOf("/") + 1);
			this.hide();
			var url = "TransportStationPms?CMD=2";
			url += "&image1=" + image1;
			url += "&image2=" + image2;
			url += "&SubId=" + id;
			url += "&t=" + Math.random();
...
function listHotel() {
	...
	ctTable.fucdel = function() {
		...
		cfBox.show();
		cfBox.accept = function() {
			var url = "TransportStationPms?CMD=8";
			url += list;
			url += "&SubId=" + my.SubId;
			url += "&r=" + Math.random();
			var f = new funPropery();
	...
	ctTable.change = function() {
		var obj = this.obj;
		var url1 = "TransportStationPms?CMD=6";
		url1 += "&id=" + obj.Id;
		url1 += "&r=" + Math.random();
		var obj = this.obj;
		var url2 = "TransportStationPms?CMD=5";
		url2 += "&id=" + obj.Id;
		url2 += "&r=" + Math.random();
		var url3 = "TransportStationPms?CMD=7";
		url3 += "&id=" + obj.Id;
	...
	ctTable.fucStatus = function() {
		var url = "TransportStationPms?CMD=9";
		url += "&id=" + this.obj.Id;
		url += "&r=" + Math.random();
		var f = new funPropery();
		f.complet = function(tx) {
...
function detailItem() {
	...
	this.show = function() {
		layer.show();
		var url = "TransportStationPms?CMD=4";
		url += "&id=" + my.obj.Id;
		url += "&r=" + Math.random();
		var f = new AjaxGetText(url);
		f.complet = function(tx) {
