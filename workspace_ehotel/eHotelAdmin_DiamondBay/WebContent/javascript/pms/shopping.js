...
function subject()
{
	...
	this.get=function()
	{
		//lay ve danh sach mainmenu truyen vao language 14.03.13
		var url="shopping?CMD=1";
		url+="&r="+Math.random();
		var f=new funPropery();				
		f.complet=function(tx)
	...
	{
		var shoppinglink = linksaveimage + image;
		$("id_table").innerHTML="<div class='div_dinningimage'> <img src='"+shoppinglink+"' width='200px' height='150px' > </div>";
	}
}
