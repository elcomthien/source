...
%>
<div class="form_detail_prom" id="form_detail_background_image"
	style="width: 590; height: 260px;">
	<div class='div_Title_prom' align="left">Background image by folio type infomation
	</div>
	<div
		...
		<div style="float: left; width: 350; height: 140px;">
			...
			<div class='pms_textbox_input' style='margin-top: 8px;'>
				...
				<div style="width: 220px; float: left; height: 30px;">
					<iframe class='frame_upload' src="../upload?bg=bg" style='float: left;'
