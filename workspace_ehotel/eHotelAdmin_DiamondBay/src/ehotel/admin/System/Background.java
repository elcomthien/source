...
public class Background extends ServiceParent {
	...
	private SystemServiceDBI systemServiceDBI = new SystemServiceDBI();
...
//				String path2 = config._pathImage + config._hotel + "/" + name + filetype;
	...
	public UUID transferBackgroundVideo(String filename, String path) {
		...
		String namesave = getFileNameByDateTime();
		String filetype = "";
		...
		System.out.println("New file: " + namesave + filetype);
		String oldfile = systemServiceDBI.updateBackgroundVideo(namesave + filetype);
		System.out.println("Old file: " + oldfile);
		ManagerFile file = new ManagerFile();
		file.deletefile(pathsave + "/" + oldfile);
		return id;
	}
