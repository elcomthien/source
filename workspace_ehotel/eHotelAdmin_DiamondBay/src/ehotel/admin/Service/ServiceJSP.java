...
public class ServiceJSP extends ServiceParent {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 7: {
			...
			System.out.println("show jsp: /vodMgn/content/formAddChannel.jsp");
			this.showJSPpage(request, response, "/vodMgn/content/formAddChannel.jsp");
			break;
		}
		case 8: {
			System.out.println("show jsp:" + Def._CtnAddMovie);
		...
		case 11: {
			// System.out.println("show jsp:"+Def._CtnAddMovie);
			System.out.println("show jsp: /serviceMng/formChangeOrder.jsp");
			this.showJSPpage(request, response, "/serviceMng/formChangeOrder.jsp");
			break;
		}
		default:
			break;
