...
public class InternetChargeReport extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private ReportServiceDBI reportServiceDBI = new ReportServiceDBI();

	public InternetChargeReport() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../report/InternetReport.jsp");
		...
		case 1: {
			...
			String st = getInternetReport(frDate, toDate);
			out.print(st);
			break;
		}
		case 2: {
	...
	public String getInternetReport(String from, String to) {
		List<InternetReportModel> list = reportServiceDBI.getInternetReport(from, to);
		String mData = "";
		...
		for (int i = 0; i < list.size(); i++) {
			...
			mData += "</room>";
			mData += "<key>";
			mData += list.get(i).getSerinumber();
			mData += "</key>";
			mData += "<time>";
			mData += "<![CDATA[" + list.get(i).getTime() + "]]>";
			mData += "</time>";
			mData += "<price>";
			mData += "<![CDATA[" + list.get(i).getPrice() + "]]>";
			mData += "</price>";
			mData += "</Item>";
		}
		mData += "</xml>";
	...
	public String getRoom(String from, String to) {
		String data = "";
		List<String> list = reportServiceDBI.getRoomInternet(from, to);
