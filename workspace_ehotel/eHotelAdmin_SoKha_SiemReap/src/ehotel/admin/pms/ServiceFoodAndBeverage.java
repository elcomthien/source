...
public class ServiceFoodAndBeverage extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private FolioServiceDBI folioServiceDBI = new FolioServiceDBI();

	public ServiceFoodAndBeverage() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsFoodAndBeverage.jsp");
