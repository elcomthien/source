...
public class ServiceHotelVegasCasino extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private FolioServiceDBI folioServiceDBI = new FolioServiceDBI();

	public ServiceHotelVegasCasino() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsHotelVegasCasino.jsp");
