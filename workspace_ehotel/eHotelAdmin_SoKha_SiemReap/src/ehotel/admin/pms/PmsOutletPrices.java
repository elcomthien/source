...
/**
 * Servlet implementation class PmsOutletPrices
 */
public class PmsOutletPrices extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private PMSServiceDBI pmsServiceDBI = new PMSServiceDBI();
	public PmsOutletPrices() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsOutletPrices.jsp");
		...
		case 1:// list subject
		{
			...
			String st = pmsServiceDBI.getSubject(LangID, 102);
			out.print(st);
			break;
		}
		case 5:// list subject left
		{
			...
			response.setContentType("text/xml");
			String str = pmsServiceDBI.getSuboutHotel(id, LangID, 102);
			out.print(str);
			break;
		}
		case 6:// list subject right
		{
			...
			response.setContentType("text/xml");
			String str = pmsServiceDBI.getSubinHotel(id, LangID, 102);
			out.print(str);
			break;
		}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 1:// insert pms subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				int id = pmsServiceDBI.addMenuService(menu, 102);
