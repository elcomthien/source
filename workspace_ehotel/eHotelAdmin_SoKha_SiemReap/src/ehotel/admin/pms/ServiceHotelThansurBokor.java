...
public class ServiceHotelThansurBokor extends ServiceParent {
	private static final long serialVersionUID = 1L;
	private FolioServiceDBI folioServiceDBI = new FolioServiceDBI();

	public ServiceHotelThansurBokor() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsHotelThansurBokor.jsp");
		...
		case 4:// show form detail
		{
			...
			this.showJSPpage(request, response, "/pmsMng/hotel/detailHotelHtml.jsp");
			break;
		}
