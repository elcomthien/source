...
function listHotel() {
	...
	ctTable.change = function() {
		var obj = this.obj;
		var url1 = "place?CMD=6";
		url1 += "&id=" + obj.Id;
		url1 += "&r=" + Math.random();
		var obj = this.obj;
		var url2 = "place?CMD=5";
		url2 += "&id=" + obj.Id;
		url2 += "&r=" + Math.random();
		var url3 = "place?CMD=7";
		url3 += "&id=" + obj.Id;
...
//		var des = getDataFromEditor("descriptionInput");
		var des = "Information of Phnom Penh";
...
function addItemHotel() {
	...
	this.load = function(id) {
		my.subid = id;
		my.show();
//		$("div-title-multi").style.display = "none";
//		var divtitle = document.getElementById("div-title-multi");
//		divtitle.innerHTML="Place";
	}
	this.show = function() {
		layer.show();
		var html = "";
