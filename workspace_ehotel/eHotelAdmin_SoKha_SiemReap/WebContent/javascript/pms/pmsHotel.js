...
//		var html = "";
		...
		f.complet = function(tx) {
			...
			var src = document.getElementById("iframe_hotel").src;
			src = src + "WebEditor/excute.elcom#" + name_file + "@" + my.obj.Title + "&" + my.obj.Id;
			document.getElementById("iframe_hotel").src = src;
...
//		var html = "";
		...
		f.complet = function(tx) {
			...
			var src = document.getElementById("iframe_hotel").src;
			src = src + "WebEditor/hello.elcom#" + my.subid;
			document.getElementById("iframe_hotel").src = src;
