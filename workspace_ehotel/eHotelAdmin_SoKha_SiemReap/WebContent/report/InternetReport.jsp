<script type="text/javascript" src="../javascript/report/internetreport.js"></script>
...
<div style="width: 1024;">
	<div>
		<div class="left_content_top">Internet Charge By Room Number</div>
			...
			<div style="width: 820; height: auto;">
				...
				<div class="form_center"
					...
					<div style="float: left; width: 100%; height: 400px;" id="div_room">
						<div
							style="width: 740px; height: 30px; margin-top: 10px; float: left; margin-left: 40px; border: 1px solid #dddddd;">
							<div style="float: left; width: 100%; margin-top: 5px;"
								id="div_time"></div>
						</div>
						<div id="div_Table"
							style="margin-left: 40px; float: left; width: 740px; overflow-x: hidden; overflow: scroll; position: relative; height: 350px; border: 1px solid #dddddd;"
							align="center"></div>
					</div>
				</div>
