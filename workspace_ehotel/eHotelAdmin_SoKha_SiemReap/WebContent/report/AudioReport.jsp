...
<script type="text/javascript" src="../javascript/report/Audioreport.js"></script>
...
<div style="width: 1024;">
	<div>
		<div class="left_content_top">
			<%=readerLang.getContent("static_of_audios") %>
		</div>
			...
			<div style="width: 820; height: auto;">
				...
				<div class="form_center"
					...
					<div style="float: left; width: 100%; height: 400px;" id="div_room">
						<div
							style="width: 740px; height: 80px; margin-top: 10px; float: left; margin-left: 40px; border: 1px solid #dddddd;">
							<div style="float: left; width: 100%; margin-top: 15px;">
								<div style="float: left; width: 100px;">
									<%=readerLang.getContent("reporttype") %>
								</div>
								<div style="float: left;">
									<select id="select_type"
										onchange="AudioReport.onchangeType(this)">
										<option value="0"><%=readerLang.getContent("static_month") %></option>
										<option value="1"><%=readerLang.getContent("static_week") %></option>
										<option value="2"><%=readerLang.getContent("static_audio") %></option>
									</select>
								</div>
							</div>
