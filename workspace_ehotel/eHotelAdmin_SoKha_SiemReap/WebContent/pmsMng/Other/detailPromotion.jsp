...
<%
	...
	String des="";
	String url="http://www.sokhahotels.com/angkor/special-offer/mega-sale";
...
<!-- 			---- -->
			...
			<div class='pms_textbox_input' style='margin-top: 8px;'>
				...
				<input type="text" size='26' style='border: 1px solid #dddddd; height: 24; float: left; width: 220px; margin-top: 5px;'
						name="nameFile" id="nameFile" value="<%=url%>" />
...
<!-- 				</div> -->
			...
			<div class='pms_textbox_input' style="visibility: hidden;">
