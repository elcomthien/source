...
<div class="form_detail_hotel" id="form_detail_hotel" style="height: auto; top: 30%; width: 370px;">
	...
	<div class='div_Title' id="div-title-multi" align="left"><%=readerLang.getContent("Hotel") %>
	</div>
	<div
		...
		<div
			...
			<img id='image' src="<%=linksaveimage + des%>" width='330'
				height='300'></img>
		</div>
	</div>
	<div style="width: 100%; float: left; margin-top: 5px;" align="center">
		<div align='left' class='div_sub_buton' style='width: 220px;'>
			<input  type="button"
				value=' <%=readerLang.getContent("OK") %>  ' id="form_textbox_ok"
				class='div_buton' style='width: 100px;'> <input type="button"
				value="<%=readerLang.getContent("Cancel") %>"
				id="form_textbox_cancel" class='div_buton' style='width: 100px;'>
		</div>
	</div>
</div>