...
<script type="text/javascript" src="../javascript/pms/pmsRoomService.js"></script>
				...
				<div class="grid_header">
					...
					<div style="float: right; width: 150px;" class="tab_menu"
						...
						<div class="tab_menu_item_sel" id="1"
							onclick="Mod.changeTab(this.id);" style="width: 120px;">
							<p style="margin-top: 5px; height: 0px;">Service</p>
						</div>
					</div>
				</div>
