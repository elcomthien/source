<script type="text/javascript" src="../javascript/pms/restaurent.js"></script>
<link rel="stylesheet" href="../css/dinning.css" type="text/css"></link>
<script type="text/javascript" src="../javascript/pms/roomService.js"></script>
<link rel="stylesheet" href="../css/pms.css" type="text/css"></link>
<script type="text/javascript" src="../javascript/pms/dinning.js"></script>
...
<div style="width: 1024;">
	<div class="left_content">
		<div class="left_content_top">
			<%=readerLang.getContent("DiningMgn") %>
		</div>
				...
				<div class="grid_header">
					...
					<div style="float: right; width: 150px;" class="tab_menu"
						...
						<div class="tab_menu_item_sel" id="1"
							...
							<p style="margin-top: 5px; height: 0px;"><%=readerLang.getContent("dinning") %></p>
						</div>
					</div>
				</div>
	...
	<div class="content_right" align="center">
		<div class="menu" style="margin-top: 25px;" id="menu">
			<div class="menu_header">
				<div style="float: left; color: white; font-size: 20px; margin-left: 20px; margin-top: 15px; font-weight: bold;">
