<div class="form_detail_dinning" style="height: 130px;; width: 375px;" id="form_detail_item">
	<div class='div_Title' align="left">Room Status
	</div>
	<div
		style="float: left; margin-left: 10px; border: 1px solid #dddddd; width: 350px; margin-top: 10px;">
		<div style="float: left; width: 350; height: 50px;">
			<div class='pms_textbox_input' style='margin-top: 2px;'>
				<div class='pms_name_input' style="margin-top: 7px;">Status Name:</div>
				<input type="text" size="26"
					style="border: 1px solid #dddddd; height: 22; float: left; width: 220; margin-top: 5px;"
					id="name" value="" />
			</div>
			<span style="color: red; display: none; margin-left: 120px; margin-top: 5px;" id="span-error-user">error</span>
		</div>
	</div>
