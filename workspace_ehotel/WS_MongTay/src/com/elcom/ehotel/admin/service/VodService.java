...
public class VodService {
	...
	public int addNewMovie(VodContentModel con, String uuid) {
		...
		con.setName(UnicodeConverter.encodeUnicode(con.getName()));
		con.setActor(UnicodeConverter.encodeUnicode(con.getActor()));
		con.setDirector(UnicodeConverter.encodeUnicode(con.getDirector()));
		con.setProductor(UnicodeConverter.encodeUnicode(con.getProductor()));
