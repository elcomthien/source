...
public class CoreSoKhaDao {
	...
	public boolean BillItem(String ROOM_NUMER,String RESERVATION_NUMER,
            String ITEM_DESC,String ITEM_AMOUNT,String DISPLAY_FLAG,String DATE,String TIME)
	{
		String result = "";
		boolean kq = false;
		ROOM_NUMER = ifNull(ROOM_NUMER);
		...
		System.out.println("In DAO.functionXI(ROOM_NUMER:"+ ROOM_NUMER + 
				",RESERVATION_NUMER:" + RESERVATION_NUMER + ",ITEM_DESC:" + ITEM_DESC + ",ITEM_AMOUNT:" + ITEM_AMOUNT+ 
				",DISPLAY_FLAG:" + DISPLAY_FLAG + ",DATE:" + DATE + ",TIME:" + TIME + ")");
		
		kq = dao.functionXI(ROOM_NUMER, RESERVATION_NUMER, ITEM_DESC, ITEM_AMOUNT, DISPLAY_FLAG, DATE, TIME, SWAP_FLAG);
		return kq;
	}
	//------------------------------------------------
