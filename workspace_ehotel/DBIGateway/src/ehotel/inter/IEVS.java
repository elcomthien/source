...
public interface IEVS {
	 ...
	 * 
	 * @param vodId
	 *            A sequence array of the desired subtitle is added.
	 * @param subTitleInfo
	 ...
	 */
	public Integer[] addSubtitle(int vodId, Vector<SubTitle> subTitleInfo);
	 ...
	 * 
	 * @param vodId
	 * @return Vector<EVSStorage>. Get all evs storages if VodId>0. Get one evs
	 *         storage of movie otherwise
	 */
	public Vector<EVSStorage> getEVSStorages(int vodId);

	/**
	 * get an absolute URL giving the base location of the movie via vodInfo
	 * 
	 * @param seqId
	 * @param vodInfo
	 *            is one of values(VOD.TRAILER ,VOD.SUBTITLE,VOD.VOD)
	 * @return
	 */
	public String getUrl(int seqId, String vodInfo);

	/**
	 * get value of vod sequence via vodInfo
	 * 
	 * @param seqId
	 * @param vodInfo
	 *            is one of values(VOD.TRAILER ,VOD.SUBTITLE,VOD.VOD)
	...
	/**
	 * get all sequence of subtitle via vodId
	 * 
	 * @param vodId
	 * @return sequence array of subtitle
	 */
