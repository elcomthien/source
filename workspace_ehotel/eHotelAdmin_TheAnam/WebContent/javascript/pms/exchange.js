...
function ListExchange()
{
	...
	{				
		...
		/*html+="</div>"
		html+="<div  align='left' width='130px;'>";
		html+="<form id='formname' action='ServiceExchange' method='post'  enctype='multipart/form-data'>";
		html+="<input type='file'  id='file_exchange'>";
		html+="<input type='submit' id='btn_file_excel' value='Import' >";
		...
		/*html+="<div class='pms_name_input' style='width: 200px;'>";
		html+="<p style='margin-left: 14px;'>Select file to upload:</p>";
		html+="</div>";*/
		html+="<input type='text' size='26'";
		html+="style='border: 1px solid #dddddd; height: 24; float: left; width: 350px; margin-top: 5px;margin-left: 14px;'";
		html+="name='nameFile' id='nameFile' value='text' readonly='readonly' />";
		html+="<div style='width: 5%; margin-top: 6px; margin-left: 0px;'>";
		html+="<iframe class='frame_upload'";
		html+="src='../upload_xls_Exchange?image=image1&bg=bg' style='float: left; width: 50px;'";
		html+="valign='top' align='left' scrolling='no' frameborder='0'";
		html+="></iframe>";
		html+="</div>";
		html+="</div>";
		...
		if(my.count>8)
		{
			...
			html+="<div class='div_page_icon_left' id='div_page_icon_left'  style='margin-top: 8px;'>";
			html+="</div>";
			for(var i=0;i<page;i++)
			{
				if(i==Index)
				{
					html+="<a class='div_page_a_sel' style='margin-top: 8px;' href=\"javascript:\" id=\""+i+"\">";
				}else
				{
					html+="<a class='div_page_a' style='margin-top: 8px;' href=\"javascript:\" id=\""+i+"\">";
				}
				html+=(i+1)
				html+=" </a>";				
			}			
			html+="<div class='div_page_icon_right' id='div_page_icon_right' style='margin-top: 8px;'>";
			html+="</div>";
			html+="</div>";
		}		
