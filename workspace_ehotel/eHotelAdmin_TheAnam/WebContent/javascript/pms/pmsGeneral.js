...
function listHotel() {
	...
	ctTable.change = function() {
		var obj = this.obj;
		var url1 = "generalPms?CMD=6";
		url1 += "&id=" + obj.Id;
		url1 += "&r=" + Math.random();
		var obj = this.obj;
		var url2 = "generalPms?CMD=5";
		url2 += "&id=" + obj.Id;
		url2 += "&r=" + Math.random();
		var url3 = "generalPms?CMD=7";
		url3 += "&id=" + obj.Id;
