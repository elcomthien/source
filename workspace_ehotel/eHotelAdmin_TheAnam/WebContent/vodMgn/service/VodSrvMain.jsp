...
<script type="text/javascript" src="../javascript/temp/serviceAdd.js"></script>

<!-- <script type="text/javascript" src="../javascript/tiny_mce/tiny_mce.js"></script> -->
<!-- <script type="text/javascript" src="../javascript/vodMng/serviceAdd.js"></script> -->

<script type="text/javascript" src="../javascript/vodMng/service.js"></script>
<!--[if IE]>
    <style type="text/css">
        div.tableContainer  {
            position: relative;
					...
					<div class="left_content">
						...
						<div class="left_content_bottom">
							<div class="grid">
								...
								<input id="id-subject-content" value="" style="display: none;">
									<input id="id-subject-service" value="" style="display: none;">
									<span
									...
									<div style="float: right;" class="tab_menu" id="tab_menu">										
										<div class="tab_menu_item" id="1" style="visibility:hidden;"
								...
								<div style="float: left; height: 25px; width: 50%; float: left; margin-top: 5px; margin-left: 30px;" id="div_search_vod_service">
									<div style="float: left; width: 150px; height: 100%;"
										align="left">
										<input type="text" id="vod_search" size="20"
											onkeyup="Vod.search();">
									</div>
									<div style="float: left;">
										<img src="../icon/find-icon.png"
											style="margin-top: 5; cursor: pointer;"
											onclick="Vod.search();"></img>
									</div>
								</div>
