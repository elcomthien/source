...
<div class="form_detail_prom" id="form_detail_promotion"
	...
	<div
		...
		<div style="float: left; width: 350; height: 140px;">
			...
			<div class='pms_textbox_input' style='margin-top: 8px;'>
				...
				<div
					style="width: 220px; float: left; height: 30px; margin-top: 5px;">
			...
			<div class='pms_textbox_input' style='margin-top: 8px;'>
				...
				<input type="text" size='26'
					style='border: 1px solid #dddddd; height: 24; float: left; width: 190px; margin-top: 5px;'
					name="nameFile" id="nameFile" value="<%=namefile%>"
					readonly="readonly" />
				<!-- 				<div style="width: 30px; margin-top: 0px;"> -->
				<iframe class='frame_upload' src="../uploadpro?image=image1&bg=bg"
					style='float: left; width: 35px; margin-top: -8px;' valign="top"
					align="left" scrolling="no" frameborder='0'></iframe>
				<!-- 				</div> -->
			</div>
		...
		<div
			style='width: 100%; height: 200; float: left; margin-top: 35px; margin-bottom: -20px;'>
	...
	<div
		style="float: right; width: 400px; height: 355px; border: 1px solid #dddddd; margin-right: 10px; margin-top: 20px;">
	...
	<div style="width: 100%; float: left; margin-top: 20px;" align="center">
		<div align='left' class='div_sub_buton'>
			<input style='' type="button"
				...
				id="form_textbox_ok" class='div_buton'> <input type="button"
