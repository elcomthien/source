...
<%
 ...
 %>
<div class="form_detail_hotel" style="height: 380; width: 590"
	id="form_detail_hotel">
	<div class='titleSubject' align="left"><%=readerLang.getContent("Activites") %>
	</div>
	<div
		style="float: left; margin-left: 10px; border: 1px solid #dddddd; width: 570px; margin-top: 10px;">
