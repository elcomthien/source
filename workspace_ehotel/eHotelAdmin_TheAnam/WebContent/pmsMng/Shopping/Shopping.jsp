...
<script type="text/javascript"
	src="../javascript/pms/roomServiceshopping.js"></script>
<link rel="stylesheet" href="../css/pms.css" type="text/css"></link>
<script type="text/javascript" src="../javascript/pms/shopping.js"></script>
<link rel="stylesheet" href="../css/table.css" type="text/css"></link>
<%@ include file="../../include/ParamterPms.jsp"%>
<script type="text/javascript" src="../javascript/pms/pmsshopping.js"></script>
<script type="text/javascript">
	var langDing={
...
<div style="width: 1024;">
	<div class="left_content">
		<div class="left_content_top">
			<%=readerLang.getContent("shoppingtitle") %>
		</div>
				...
				<div class="grid_header">
					...
					<div style="float: right; width: 150px;" class="tab_menu"
						...
						<div class="tab_menu_item_sel" id="1"
							...
							<p style="margin-top: 5px; height: 0px;"><%=readerLang.getContent("shoppingtableft") %></p>
						</div>
					</div>
				</div>
	...
	<div class="content_right" align="center">
		<div class="menu" style="margin-top: 25px;" id="menu">
			...
			<div class="menu_center" align="center">
				<div id='menutree'></div>
				<div>
					<a href="javascript:dinning.sub.addSubject(22);"
