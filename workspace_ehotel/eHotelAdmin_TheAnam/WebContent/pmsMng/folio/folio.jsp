...
<div style="width: 1024;">
	<div>
		...
		<div class="left_content_bottom" align="center">
			...
			<!--<div style="float: right; width: 330px;" class="tab_menu"   -->		<div style="float: right; width: 230px;" class="tab_menu"
						id="tab_menu">
						...
						<div class="tab_menu_item" id="3"
							onclick="folio.changeTab(this.id);" style="display: none;"><!-- onclick="folio.changeTab(this.id);" style="display: none;"> -->
						...
						<div
							...
							<div
								...
								<div
									...
									<div style="float: left; width: 100%; background-color: white; height: 250; overflow: auto;"
