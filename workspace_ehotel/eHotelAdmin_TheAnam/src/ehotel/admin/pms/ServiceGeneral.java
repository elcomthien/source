...
public class ServiceGeneral extends ServiceParent {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsGeneral.jsp");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case 1:// insert pms subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				boolean flag = pmsServiceDBI.addSubjectHotel(subjectName, 25,
	...
	public static void main(String[] args) {
		ServiceGeneral s = new ServiceGeneral();
