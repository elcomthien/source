...
public class ServiceTransportStation extends ServiceParent {
	...
	public ServiceTransportStation() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case -1: {
			...
			request.setAttribute("fileJSP", "../pmsMng/hotel/pmsTransportStation.jsp");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case 1:// insert pms subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				boolean flag = pmsServiceDBI.addSubjectHotel(subjectName, 35,
	...
	private String getMainMenuHotel() {
		...
		list = pmsServiceDBI.getMainMenu(35, LangID);
		String mData = "";
		mData += "<?xml version=\"1.0\" encoding=\"ISO-8859-1\" standalone=\"yes\" ?>\n";
		mData += "<xml>";
	...
	public static void main(String[] args) {
		ServiceTransportStation s = new ServiceTransportStation();
