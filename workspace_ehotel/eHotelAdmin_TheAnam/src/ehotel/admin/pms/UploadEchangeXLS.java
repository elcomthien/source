...
public class UploadEchangeXLS extends HttpServlet{
	private static final long serialVersionUID = 1L;
	public UploadEchangeXLS() {
		super();
	}
	public void destroy() {
	...
	{		
		...
		if(cmd.equals(""))
		{
			showJSPpage(request,response,"/pmsMng/folio/upload_xls_Exchange.jsp");
		}
	}
			...
			throws ServletException, IOException 
	{
		...
		Config config=loader.getConfig();			
			...
			//String path = config._file_exchange;   //chạy trên server VPL thi bo rang buoc nay ra va dong lai 2 dong duoi filepath va path
