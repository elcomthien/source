...
public class ServiceAdminRoleMng extends ServiceParent{
	...
	throws ServletException, IOException {
		...
		case -1:
			...
			boolean _isadmin= IsAdmin(request,response);
			if(!_isadmin){
				kqf="false";
			}else{
				kqf="true";
			...
			request.setAttribute("isAdmin", kqf);
...
//			System.out.print(kq);
	...
	private String getsubMod()
	{
		...
		if(vCategory.size()!=0){
			mData+="<xml menuIdCT=\""+vCategory.get(0).getCateId()+"\">";
		}else{
			mData+="<xml menuIdCT=\""+0+"\">";
		}
