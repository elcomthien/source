...
import ehotel.admin.dbi.IMBroker2;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 3:// xoa subject
		{
			...
			if (request.getParameter("id") != null) {
				...
				modContentServiceDBI.removeSubject(idsub, "CONTENT");
			}
			break;
		}
		case 4:// xoa song
...
//				System.out.println(success);
		...
		case 7:// update subject to mod
		{
			...
			modContentServiceDBI.changeSubjectOfMod(modId, param, "CONTENT");
			out.print(t);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 1:// insert subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				modContentServiceDBI.addNewSubject(subjectName, image, urlBg, parent, "CONTENT");
				String mData = "";
		...
		case 2:// edit subject
		{
			...
			if (request.getParameter("name") != null) {
				if (request.getParameter("subid") != null) {
					...
					modContentServiceDBI.editSubject(subjId, subjectName, image, urlBg, LangID, "CONTENT");
					out.print(t);
					if (t > 0) {
						// luu hinh anh subject
						ManagerFile file = new ManagerFile();
		...
		case 3:// edit song
		{
			...
			modContentServiceDBI.updateMod(id, title, singer, def, title, album, LangID, "COTNENT");
			out.print(t);
			break;
		}
		default:
	...
	public boolean deleteFileInFtpServer(int id) {
		...
		String filename = modContentServiceDBI.getFileNameModById(id);
		modContentServiceDBI.deleteModDbi(id);
		ConfigLoader loader = new ConfigLoader();
		Config config = loader.getConfig();
