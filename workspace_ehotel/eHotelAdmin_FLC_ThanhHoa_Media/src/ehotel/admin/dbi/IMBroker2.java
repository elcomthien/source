...
public class IMBroker2
{
  //The Singleton pattern
  private static IMBroker2 instance = null;
  //Get configuration object
  //To refers to DBIPool, contains logic connections to the DBI
  private DBIPool2 dbiPool = null;
  //To log application
  private static final Logger logger = LogManager.getLogger(IMBroker2.class);

  private IMBroker2()
  {
    dbiPool = new DBIPool2(2);
  }

  public static synchronized IMBroker2 getInstance()
  {
    if (instance == null)
    {
      instance = new IMBroker2();
    }
