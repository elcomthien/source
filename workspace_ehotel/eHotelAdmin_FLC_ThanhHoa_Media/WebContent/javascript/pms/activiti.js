...
var acti=new function Activiti()
{
	var my=this;
...
function List()
{
	...
	{		
		...
		if(this.List.length==0)
		{
			...
			html+="<a href='javascript:acti.list.addeImage()' class='div_addeImage' title='Click here add Image'>"+langpms.addItem+"</a>";
			html+="</div>";
		}
		if(my.count>6)
		{
...
{ 	    
	 document.body.onclick=acti.onclick;	    	
	 $("div_addeSubject").href="javascript:acti.sub.addSubject(-1);";
}