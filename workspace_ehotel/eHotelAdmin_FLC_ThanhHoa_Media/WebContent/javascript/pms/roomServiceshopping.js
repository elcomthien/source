		...
		var url="shopping?CMD=2";
			...
			{							
				...
				{					
					...
					my.List[i]=new Item(_id,_name,_des,_status,_image,_price);	
				}	
...
function AddShoppingItem()
{
	...
	//show window de them shopping vao
	this.show=function()
	{			
		layer.show();
		var html="";
		var url="shopping?CMD=4";
			url+="&id="+my.subid;
			url+="&r="+Math.random();		
	...
	this.renderEvent=function()
	{
		...
		{  
			$("div_money1").selectedIndex=this.selectedIndex;
			$("div_money2").selectedIndex=this.selectedIndex;
		}
	}
	...
	{			
		...
		var price_small=$("price_small").value;
		var price_large=$("price_large").value;
		...
		{
			var albox=new alertBox();
			albox.show(langDing.pls_price_small);
			return;
		}
		if(price_large.length==0)
		{
			var albox=new alertBox();
			albox.show(langDing.pls_price_large);
			return;
		}
		...
		var url="shopping?CMD=3";
			url+="&subid="+my.subid;
			url+="&image="+image;
			url+="&t="+Math.random();
			var param="&name="+name;
			param+="&price="+price;	
			param+="&price_small="+price_small;
			param+="&price_large="+price_large;			
			param+="&image="+image;
			param+="&unit="+unit;
			param+="&des="+(des);	
...
function Item(id,title,des,status,image,price)
{
	this.Id=id;
