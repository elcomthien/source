					...
					<div class="left_content">
						...
						<div class="left_content_bottom">
							<div class="grid">
								...
								<div style="float: left; height: 25px; width: 50%; float: left; margin-top: 5px; margin-left: 30px;" id="div_search_vod_content" >
					...
					<div class="content_right" align="center">
						<div class="menu" style="margin-top: 25px;" id="menu">
							...
							<div class="menu_center" align="center">
								...
								<div class='div_linkadd' style="display: none;">
