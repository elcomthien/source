...
public class VodController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("editsubject")) {
			...
			LogUtil.logControl(VodController.class.toString(), "editsubject", "idSubject,,," + idSubject + ",,,name,,," + name + ",,,image,,,"
					+ image + ",,,langid,,," + langid + ",,,invisible,,," + invisible);
		...
		if (action.equals("addmovie")) {
			...
			LogUtil.logControl(VodController.class.toString(), "addmovie", "idSubject,,," + idSubject + ",,,name,,," + name + ",,,productor,,,"
					+ productor + ",,,director,,," + director + ",,,actor,,," + actor + ",,,poster,,," + poster + ",,,plot,,," + plot + ",,,price,,,"
					+ price + ",,,iunit,,," + iunit + ",,,url,,," + url + ",,,invisible,,," + invisible + ",,,isnew,,," + isnew + ",,,uuid,,," + uuid);
		...
		if (action.equals("editmovie")) {
			...
			LogUtil.logControl(VodController.class.toString(), "addmovie", "idSubject,,," + idSubject + ",,,idContent,,," + idContent + ",,,name,,,"
					+ name + ",,,productor,,," + productor + ",,,director,,," + director + ",,,actor,,," + actor + ",,,poster,,," + poster
					+ ",,,plot,,," + plot + ",,,price,,," + price + ",,,iunit,,," + iunit + ",,,invisible,,," + invisible + ",,,isnew,,," + isnew
					+ ",,,langid,,," + langid);
		...
		if (action.equals("deletemovie")) {
			...
			LogUtil.logControl(VodController.class.toString(), "deletemovie", "idContent,,," + idContent + ",,,uuid,,," + uuid + ",,,ipserver,,,"
					+ ipserver);
