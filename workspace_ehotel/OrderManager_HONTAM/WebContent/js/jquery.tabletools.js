...
var TableToolsInit = {
	...
	"sPrintInfo": "<h6>Print</h6><p>Please use your browser's print function to "+
...
function TableTools ( oInit )
{
	...
	function fnFeatureSavePDF ()
	{
		var sBaseClass = "TableTools_button TableTools_pdf";
		var nButton = document.createElement( 'div' );
		nButton.id = "ToolTables_PDF_"+_iId;
		nButton.style.height = _oSettings.iButtonHeight+'px';
		nButton.style.width = _oSettings.iButtonWidth+'px';
		nButton.className = sBaseClass;
		_nTools.appendChild( nButton );
		...
		clip.setHandCursor( true );
		clip.setAction( 'save' );
		clip.setFileName( fnGetTitle()+'.pdf' );
		...
		fnGlue( clip, nButton, "ToolTables_PDF_"+_iId, "Save for PDF" );
	}
