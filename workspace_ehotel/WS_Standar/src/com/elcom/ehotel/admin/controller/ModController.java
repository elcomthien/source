...
public class ModController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("addsubject")) {
			...
			LogUtil.logControl(ModController.class.toString(), "addsubject", "name|" + name + "|image|" + image + "|invisible|" + invisible + "|index|" + index);
		...
		if (action.equals("editsubject")) {
			...
			LogUtil.logControl(ModController.class.toString(), "editsubject", "idSubject|" + idSubject + "|name|" + name + "|image|" + image
		...
		if (action.equals("addmod")) {
			...
			LogUtil.logControl(ModController.class.toString(), "addmod", "idSubject|" + idSubject + "|name|" + name + "|url|" + url + "|invisible|"
					+ invisible);
		...
		if (action.equals("editmod")) {
			...
			LogUtil.logControl(ModController.class.toString(), "editmod", "idSubject|" + idSubject + "|idContent|" + idContent + "|name|" + name
