...
public class LiveTVController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("getvideo")) {
			LogUtil.logControl(LiveTVController.class.toString(), "getvideo", "none");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("addnewsubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "addnewsubject", "name,,," + name + ",,,image,,," + image
					+ ",,,status,,," + status + ",,,listadd,,," + listadd + ",,,index,,," + index);
		...
		if (action.equals("editsubject")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "editsubject", "idsubject,,," + id + ",,,name,,," + name + ",,,image,,,"
					+ image + ",,,status,,," + status + ",,,listadd,,," + listadd + ",,,listremove,,," + listremove + ",,,index,,," + index);
		...
		if (action.equals("addvideo")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "addvideo", "name,,," + name + ",,,url,,," + url + ",,,status,,," + status);
...
//			String image = request.getParameter("image");
			...
			LogUtil.logControl(LiveTVController.class.toString(), "editvideo", "id,,," + id + ",,,name,,," + name + ",,,url,,," + url
		...
		if (action.equals("deletevideo")) {
			...
			LogUtil.logControl(LiveTVController.class.toString(), "deletevideo", "id,,," + id);
