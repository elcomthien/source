...
public class LiveTVDao {
	...
	public int addNewSubjectLiveTV(LiveTVSubjectModel livetv) {
		...
		LogUtil.logDao(LiveTVDao.class.toString(), SQL.ADD_LIVETV_SUBJECT, params, "name,image,status,listadd,index", rs);
	...
	public List<HashMap<String, String>> getListVideo() {
		...
		LogUtil.logDao(LiveTVDao.class.toString(), SQL.GET_LIST_VIDEO, params, "none", outParam.size() / 6);
		for (int i = 0; i < outParam.size(); i = i + 6) {
	...
	public int addVideo(String name, String url, String status) {
		...
		LogUtil.logDao(LiveTVDao.class.toString(), SQL.ADD_VIDEO, params, "name,url,status", rs);
		return rs;
	}
	...
	public int editVideo(String id, String name, String url, String status, String index) {
		...
		LogUtil.logDao(LiveTVDao.class.toString(), SQL.EDIT_VIDEO, params, "id,name,url,status,index", rs);
		return rs;
	}
	...
	public int deleteVideo(String id) {
		...
		LogUtil.logDao(LiveTVDao.class.toString(), SQL.DELETE_VIDEO, params, "id", rs);
		return rs;
	}
...
//		LiveTVDao l = new LiveTVDao();
		...
		// String t = "http://ehotel.elcom.vn/loop_video/abc.mp4[@]http://ehotel.elcom.vn/loop_video/xyz.mp4";
		// String[] arr = t.split("\\[@\\]");
