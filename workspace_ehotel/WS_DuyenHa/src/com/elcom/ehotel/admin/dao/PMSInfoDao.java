...
public class PMSInfoDao {
	...
	public int editSubjectInfo(PMSInfoSubjectModel info) {
		...
		LogUtil.logDao(PMSInfoDao.class.toString(), SQL.EDIT_SUBJECT_INFO, params, "serviceId,subjectId,name,image,invisible,index,langid",
				rs);
	...
	public static void main(String[] args) {
		...
		System.out.println(p.getListContentInfo(466, 1));
	}
}
