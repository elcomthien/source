<script type="text/javascript" src="../javascript/report/productionreport.js"></script>
			...
			<div style="width: 820; height: auto;">
				...
				<div class="form_center"
					...
					<div style="float: left; width: 100%; height: 400px;" id="div_room">
						<div style="width: 740px; height: 30px; margin-top: 10px; float: left; margin-left: 40px; border: 1px solid #dddddd;">
