...
<script type="text/javascript"
	src="../javascript/report/Livetvreport.js"></script>
...
<div style="width: 1024;">
	<div>
		<div class="left_content_top" style="margin-left: 0px;">
			<%=readerLang.getContent("static_of_livetvs") %>
		</div>
