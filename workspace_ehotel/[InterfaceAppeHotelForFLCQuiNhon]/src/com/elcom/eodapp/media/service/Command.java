...
public interface Command {
	...
	public static int com_getSubMenu = 107;     //danh sach của chu con serivece dining
	...
	public static int com_getOrderHistory = 130;
	public static int com_getChannelView = 131;
