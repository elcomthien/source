...
public class CoreMedia extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (lenh == Command.com_getlang) {
			...
			String xml = casdao.getLangs(keystb, ip);
			System.out.println(xml);
			out.println(xml);
			return;
		...
		if (lenh == Command.com_getlistsubjectvod) {
			...
			String type = request.getParameter(Param.type);
			String xml = voddao.getAllNorSubjects(keystb, type);
			System.out.println(xml);
			out.println(xml);
			return;
		} else
		...
		if (lenh == Command.com_getMessageInfo) {
			...
			String xml = pmsdao.getWelcomeMessage(keystb, typetvbox);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			String xml = pmsdao.getAdverImages(keystb, types);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			String xml = pmsdao.getMainMenu(serviceid, keystb);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			String xml = pmsdao.getOultetImage(outletid, outletType, keystb);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			String xml = pmsdao.getSubMenu(mainMenuId, keystb);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			String xml = pmsdao.getItemOfService(subMenuId, keystb, ffrom, tto);
			System.out.println(xml);
			out.println(xml);
			return;
		} else if (lenh == Command.com_getBills) {

			System.out.println("getBill lenh: " + lenh + " -- keystb: " + keystb);

			String xml = pmsdao.getBills(keystb);
			System.out.println(xml);
			out.println(xml);
			return;
			...
			out.println(xml);
			return;
		} else if (lenh == Command.com_getOrderHistory) {
			System.out.println("lenh: " + lenh + " - keystb: " + keystb);

			String xml = pmsdao.getOrderHistory(keystb);
			System.out.println(xml);
			out.println(xml);
			return;
		} else if (lenh == Command.com_getChannelView) {
			System.out.println("lenh: " + lenh + " - keystb: " + keystb);

			String xml = pmsdao.insertViewChannel(keystb, channelid);
			System.out.println(xml);
			out.println(xml);
			return;
