...
public interface SQL {
	...
	public static final String sqlgetOrderHistory = "{call PMSAPP.getOrderHistory(?,?)}";
	public static final String sqlinsertChannelView = "{call PMSAPP.insertViewChannel(?,?,?)}";
