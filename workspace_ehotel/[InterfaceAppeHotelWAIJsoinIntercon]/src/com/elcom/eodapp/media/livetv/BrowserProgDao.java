...
public class BrowserProgDao {
	...
	public String getListChannel(String keystb, String subjectid) throws IOException {
		String jstext = "";
		JSONObject obj = new JSONObject();
		JSONArray ja = new JSONArray();
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(keystb), 0);
		params.add(in);
		...
		params.add(subOut);
		try {
			params = broker.executeSubPro(SQL.GET_LIST_CHANNEL, params);
