...
public class CoreMedia extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request,
		...
		if (lenh == Command.com_getMessageInfo) {
			...
			out.println(xml);
			return;
		} else if (lenh == Command.com_getPopup) {
			System.out.println("lenh: " + lenh + " - keystb: " + keystb);

			String xml = pmsdao.getPopup(keystb);
			System.out.println(xml);
			out.println(xml);
			return;
		} else if (lenh == Command.com_setViewPopup) {
			String idpopup = request.getParameter(Param.id);
			System.out.println("lenh: " + lenh + " - keystb: " + keystb);

			String xml = pmsdao.setViewPopup(keystb, idpopup);
			System.out.println(xml);
			out.println(xml);
			return;
		}
