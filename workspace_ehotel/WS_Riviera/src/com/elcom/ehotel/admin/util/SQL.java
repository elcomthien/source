...
public class SQL {
	...
	public static final String GET_LIST_ALL_CHANNEL = "BEGIN ELIVETV.getAllChannels(?); END;";
	...
	// pms weather
	public static final String GET_LIST_WEATHER = "BEGIN EPMS.getListCountryWeather(?); END;";
	public static final String ADD_COUNTRY_WEATHER = "BEGIN EPMS.addCountryWeather(?,?,?,?,?,?,?,?,?); END;";
	public static final String EDIT_COUNTRY_WEATHER = "BEGIN EPMS.editCountryWeather(?,?,?,?,?,?,?,?,?,?); END;";
	public static final String DELETE_COUNTRY_WEATHER = "BEGIN EPMS.deleteCountryWeather(?,?); END;";

	// pms Item service
	public static final String GET_ITEM_SERVICE = "BEGIN EPMS.getItemService(?,?,?); END;";
	public static final String EDIT_ITEM_SERVICE = "BEGIN EPMS.editItemService(?,?,?,?,?,?,?,?,?); END;";
	...
	// interface
	public static final String INTERFACE_CHECKIN = "BEGIN EPMS.interfaceCheckin(?,?,?,?,?,?,?); END;";
	public static final String INTERFACE_CHECKOUT = "BEGIN EPMS.interfaceCheckout(?,?); END;";
