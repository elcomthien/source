...
public class PMSInfoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("editsubjectinfo")) {
			...
			LogUtil.logControl(PMSInfoController.class.toString(), "editsubjectinfo", "serviceId|" + serviceId + "|subjectId|" + subjectId
					+ "|subjectName|" + subjectName + "|image|" + image + "|invisible|" + invisible + "|index|" + index
					+ "|langId|" + langId);
