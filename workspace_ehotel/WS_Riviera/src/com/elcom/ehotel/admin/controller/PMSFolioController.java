...
import com.elcom.ehotel.admin.service.InterfaceService;
...
public class PMSFolioController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("interface")) {
			String path = request.getParameter("path");

			LogUtil.logControl(PMSFolioController.class.toString(), "interface", "path|" + path);

			Map<String, Object> list = new HashMap<String, Object>();
			list = interfaceService.interfaceFileXML(path);
			response.getWriter().write(new Gson().toJson(list));
		}
	}
