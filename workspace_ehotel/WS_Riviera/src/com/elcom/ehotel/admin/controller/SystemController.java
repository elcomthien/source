...
public class SystemController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("updatetextwelcome")) {
			...
			// String logo02 = request.getParameter("logo02");
			// String logosmall02 = request.getParameter("logosmall02");
			// String welcome0 = request.getParameter("welcome0");
			// String welcome1 = request.getParameter("welcome1");
