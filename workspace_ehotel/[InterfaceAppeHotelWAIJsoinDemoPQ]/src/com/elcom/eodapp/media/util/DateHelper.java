...
public final class DateHelper {
	...
	public static long getDateInSeconds(java.util.Date d) {
		...
		long seconds = ((year - 1900) * 365 * 24 + (year - 1900) * 6 + month * 30 * 24 + day * 24) * 60 * 60;
	...
	public static String convertLenh(int lenh) {
		...
		if (lenh == 1)
			return "com_getlistsubjectvod";
		if (lenh == 2)
			return "com_getlistfileofsubject";
		if (lenh == 3)
			return "com_getdetailfilm";
		if (lenh == 4)
			return "com_getountilm";
		if (lenh == 5)
			return "com_getlisturlsub";

		if (lenh == 11)
			return "com_getmodsubject";
		if (lenh == 12)
			return "com_getModListSongSubject";
		if (lenh == 13)
			return "com_getountmusic";
		if (lenh == 14)
			return "com_getUrlImageBack";
		if (lenh == 15)
			return "com_chargeVod";
		if (lenh == 16)
			return "com_checkpaid";

		if (lenh == 21)
			return "com_getlivesubject";
		if (lenh == 22)
			return "com_getlivechannel";
		if (lenh == 23)
			return "com_getlivechannel";
		...
		if (lenh == 37)
			return "com_setScheduleStb";
		if (lenh == 38)
			return "com_getListRecordStb";
		if (lenh == 39)
			return "com_delScheduleStb";
		if (lenh == 40)
			return "com_updateStatusStbRecord";
		if (lenh == 41)
			return "com_getListRecordCore";
		if (lenh == 42)
			return "com_updateLinkStbRecord";
