...
<div class="" id="formTrailer">
	<div style="float: left; margin-left: 10px; margin-top: 10px; width: 54%; height: 250px; border: 1px solid #dddddd; overflow: hidden; overflow-y: scroll; overflow-x: auto;">
	...
	<div style="width: 350px; height: auto; float: right; margin-top: -285px;">
			<div style="float: left; margin-top: 0px;">Logo channel:
			</div>
			...
			<div class="div_row_right_ctn" style="margin-top: 20px;">
				<div style="width: 100px; float: left;" class="div_left_ctnadd">
					Choose logo:
				</div>
			...
			<div class="div_row_right_ctn">
				<div style="width: 100px; float: left; " class="div_left_ctnadd">Channel name:
				</div>
		...
		<div style="width: 200px; height: 30px;">
			<input type="button" value='Add channel' class='div_buton' id="ctn_button_ok" style="width: 90px;">
			<input type="button" value='Reset' class='div_buton' id="ctn_button_Cancel" style="width: 90px;">
		</div>
