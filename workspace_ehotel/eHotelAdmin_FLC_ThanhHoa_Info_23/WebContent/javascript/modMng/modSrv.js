	...
	ctMenu.fucchangestatus = function() {
		...
		f.complet = function(tx) {
			if(tx == "t")
				...
				albox.show("Update status invisible mod subject service error!");
			}
		};
	};
	var my=this;
	...
	menu.renderEvent=function()
	{
		...
		{			
			...
			{	
				...
				my.selectID(this.id);
				return my.showMenu(this.id,e,invi);					
			};								
		}
	};
	this.showMenu=function(id,e, invi)
	{
