...
<div class="form_detail_hotel" id="formAddVideo">
	<div class='div_Title' align="left">Add Welcome Media</div>
	...
	<div style="float: left; width: 100%; text-align: left; height: 25px; margin-top: 10px;">
		<div style="float: left; width: 80px; color: #878888; margin-left: 10px;">
			Name:</div>
		<input id="input-name" placeholder="Input name ...." style="width: 80%;">
	</div>
	
	<div style="float: left; width: 100%; text-align: left; height: 25px; margin-top: 10px;">
		<div style="float: left; width: 80px; color: #878888; margin-left: 10px;">
			Index:</div>
		<input id="input-index" placeholder="Input index ...." style="width: 80%;">
	</div>
	...
	<div style="width: 100%; height: auto; float: left; margin-top: 10px;"
		...
		<div style="width: 200px; height: 30px;">
			<input type="button" value='Add Media' class='div_buton'
				...
				type="button" value='Close' class='div_buton' id="ctn_button_Cancel"
				style="width: 90px;">
		</div>
