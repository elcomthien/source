...
@XmlRootElement(name = "guestMessageText")
public class GuestMessageText {
    ...
    @XmlElementRef(name = "MESSAGE_TEXT", namespace = "http://service.ehotel.eodapp.elcom.com", type = JAXBElement.class, required = false)
