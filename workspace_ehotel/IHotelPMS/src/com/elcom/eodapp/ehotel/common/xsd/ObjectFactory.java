...
public class ObjectFactory {
    ...
    private final static QName _ORoomDataVOICEMAIL_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "vOICE_MAIL");
    private final static QName _ORoomDataROOMSTATUS_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "rOOM_STATUS");
    private final static QName _ORoomDataROOMNUMBER_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "rOOM_NUMBER");
    private final static QName _ORoomDataUSERID_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "uSERID");
    private final static QName _ORoomDataCLEARTEXT_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "cLEAR_TEXT");
    ...
    private final static QName _OMessageDelMESSAGEID_QNAME = new QName("http://common.ehotel.eodapp.elcom.com/xsd", "mESSAGE_ID");
    ...
    /**
     * Create an instance of {@link ORoomData }
     * 
     */
    public ORoomData createORoomData() {
        return new ORoomData();
    }
    ...
    /**
     * Create an instance of {@link OMessageDel }
     * 
     */
    public OMessageDel createOMessageDel() {
        return new OMessageDel();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "vOICE_MAIL", scope = ORoomData.class)
    public JAXBElement<String> createORoomDataVOICEMAIL(String value) {
        return new JAXBElement<String>(_ORoomDataVOICEMAIL_QNAME, String.class, ORoomData.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "rOOM_STATUS", scope = ORoomData.class)
    public JAXBElement<String> createORoomDataROOMSTATUS(String value) {
        return new JAXBElement<String>(_ORoomDataROOMSTATUS_QNAME, String.class, ORoomData.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "rOOM_NUMBER", scope = ORoomData.class)
    public JAXBElement<String> createORoomDataROOMNUMBER(String value) {
        return new JAXBElement<String>(_ORoomDataROOMNUMBER_QNAME, String.class, ORoomData.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "uSERID", scope = ORoomData.class)
    public JAXBElement<String> createORoomDataUSERID(String value) {
        return new JAXBElement<String>(_ORoomDataUSERID_QNAME, String.class, ORoomData.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "cLEAR_TEXT", scope = ORoomData.class)
    public JAXBElement<String> createORoomDataCLEARTEXT(String value) {
        return new JAXBElement<String>(_ORoomDataCLEARTEXT_QNAME, String.class, ORoomData.class, value);
    }
    ...
    public JAXBElement<String> createOPostROOMNUMBER(String value) {
        return new JAXBElement<String>(_ORoomDataROOMNUMBER_QNAME, String.class, OPost.class, value);
    }
    ...
    public JAXBElement<String> createOPostCLEARTEXT(String value) {
        return new JAXBElement<String>(_ORoomDataCLEARTEXT_QNAME, String.class, OPost.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "rESERVATION_NUMER", scope = OMessageDel.class)
    public JAXBElement<String> createOMessageDelRESERVATIONNUMER(String value) {
        return new JAXBElement<String>(_OBillRESERVATIONNUMER_QNAME, String.class, OMessageDel.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "rOOM_NUMBER", scope = OMessageDel.class)
    public JAXBElement<String> createOMessageDelROOMNUMBER(String value) {
        return new JAXBElement<String>(_ORoomDataROOMNUMBER_QNAME, String.class, OMessageDel.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://common.ehotel.eodapp.elcom.com/xsd", name = "mESSAGE_ID", scope = OMessageDel.class)
    public JAXBElement<String> createOMessageDelMESSAGEID(String value) {
        return new JAXBElement<String>(_OMessageDelMESSAGEID_QNAME, String.class, OMessageDel.class, value);
    }
