...
//								action = "<td style='text-align: center;' class='fontsizetr'></td>";
							body += "<tr>" + checkdelete + stt + name + detail
									+ quantity + folio + implementation
									+ status + action + "</tr>";
						}
						if (value.trangthai == "0") {
							temp++;
...
//									+ value.ngaydat + "</td>";
	...
	var table = "<table id='tablelistorder' class='table'><thead>" + "<tr>"
			...
			+ "<th style='text-align: center; width: 24%;'>Name</th>"
...
//			+ "<th style='text-align: center; width: 10%;'>Date Order</th>"
			+ "<th style='text-align: center; width: 15%;'>Date Order</th>"
