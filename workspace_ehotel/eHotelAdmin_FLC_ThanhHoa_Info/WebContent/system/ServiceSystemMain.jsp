...
<script type="text/javascript"
	src="../javascript/charts/Chart.js"></script>
<script type="text/javascript"
	src="../javascript/system/MemorySystem.js"></script>
<script type="text/javascript"
			...
			<div class="grid">
				<div class="grid_header">
					...
					<div class="tab_menu" id="tab_menu" style="float: right; width: 330px;" >
						...
						<div class="tab_menu_item" id="1" onclick="other.changeTab(this.id);">
							<p style="margin-top: 5px;height: 20px;"><%=readerLang.getContent("daemon")%></p>
						</div>
						
						<div class="tab_menu_item" id="2" onclick="other.changeTab(this.id);">
							<p style="margin-top: 5px;height: 20px; font-size: 15px;">Performance</p>
						</div>
					</div>
				</div>
