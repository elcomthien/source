				...
				html+="<div class='form_textbox_center' style='width: 100%;'>";
					...
					html+="<div class='pms_textbox_input'>";
						...
						html+="<div  style='float:left;width:220;height: 25px;margin-top: 8px;'>";
							html+="	<iframe class='frame_upload' src=\"../imageupload\?image=image1\" valign=\"top\" scrolling=\"no\" frameborder='0' width=\"100%\" height=\"40px\" ></iframe>";
						html+="</div>";
					html+="</div>";
						html+="<div class='pms_textbox_input'>";
							html+="<div class='pms_name_input' style='width:120;'>"+langpms.Background+":</div>";
							html+="<div  style='float:left;width:220;height: 25px;margin-top: 8px;' >";
									html+="	<iframe class='frame_upload' src=\"../upload\?image=image2\" valign=\"top\" scrolling=\"no\" frameborder='0' width=\"100%\" height=\"40px\" ></iframe>";
							html+="</div>";
						html+="</div>";
