...
<%
	...
	if (session.getAttribute("user") != null) {
		...
		if (!iuser.isAdmin(ipAdress)) {
			try {
				if (iuser.checkRoleUser(ipAdress, "CONTENT$VOD")) {
					link1 = "Content/VodCtnMain?MenuId=1&SubId=1";
				}
				if (iuser.checkRoleUser(ipAdress, "CONTENT$MOD")) {
					link1 = "Content/ModCtnMain?MenuId=1&SubId=2";
				}
				if (iuser.checkRoleUser(ipAdress, "SERVICE$VOD")) {
					link2 = "Service/VodSrvMain?MenuId=2&SubId=5";
				}
				if (iuser.checkRoleUser(ipAdress, "SERVICE$MOD")) {
				...
				if (iuser.checkRoleUser(ipAdress, "SERVICE$IPTV")) {
					link4 = "Service/LiveTVMain?MenuId=2&SubId=7";
				}
				if (iuser.checkRoleUser(ipAdress, "PMS$FOLIO")) {
					link5 = "pms/folioPms?MenuId=4&SubId=11";
				}
				if (iuser.checkRoleUser(ipAdress, "PMS$HOTEL")) {
				...
				if (iuser.checkRoleUser(ipAdress, "PMS$OTHER")) {
