...
//			html += "</td>";
			...
			html += "</td>";
			html+="<td align=\"center\" valign=\"middle\">";
			html+="<img src=\"../images/edit-message.png\" width='30px;' title='Edit Message Content' onclick=\"editMessage(\'"+this.List[i].Id.replace("\n", "")+"\',\'"+encodeURI(this.List[i].From)+"\',\'"+encodeURI(this.List[i].Name)+"\',\'"+encodeURI(this.List[i].Content)+"\');\" style='cursor: pointer;'></img>";
//			html+="<img src=\"../images/edit-message.png\" width='30px;' title='Edit Message Content' onclick=\"editMessage(\'"+this.List[i].Id+"\',\'"+encodeURI(this.List[i].From)+"\',\'"+encodeURI(this.List[i].Name)+"\',\'"+encodeURI(this.List[i].Content)+"\');\" style='cursor: pointer;'></img>";
//			html+="<img src=\"../images/edit-message.png\" width='30px;' title='Edit Message Content' onclick=\"editMessage(\'1\',\'2\',\'3\',\'4\');\" style='cursor: pointer;'></img>";
			html+="</td>";
			html += "</tr>";
		}
		html += "</table>";
...
function contextTable() {
	...
	this.load = function(_obj, e) {
		...
		my.draw(posx, posy - 10, my.id_);
	};
	this.draw = function(x, y, id_) {
		my.state = true;
		var html = "";
		html += "<ul>";
//		if (my.obj.Status == 1) {
...
function editMessage(id,sender,subject,content){
...
//		document.getElementById("descriptionInput").innerHTML = content;
		initTinymceMess(2, "540px");
		$("messagesender").value = sender;
		$("messagesubject").value = subject;
		
//		$("descriptionInput").html = content;
//		document.getElementById("name").readOnly = true;
//		$("image").src = link + "/" + name + ".png";
		$("messok").onclick=function() { my.accept(id); };
