...
{	
	...
	{				
		...
		html+="<div class=\"form_textbox\" id=\"form_textbox\" style='width: 440px;height:370;'  align='center'>";
			html+="<div class=\"form_textbox_subject\"><div class='div_title_form_new_src' >"+title+"</div></div>";
...
function newBox(title,name,image,titleName,titleIma,ok,cancel)
{
	...
	{		
		...
		html+="<div class=\"form_textbox\" id=\"form_textbox\"  align='center'>";
			html+="<div class=\"form_textbox_subject\"><div class='div_title_form_new_src' style='background-color:#D3D0BE'>"+title+"</div></div>";
				html+="<div class='form_textbox_center'>"							
					html+="<div class='left_textbox'>"	
						...
						html+="<div class='div_name_input' >"+titleName+":</div>"	
							html+="<input type=\"text\"    style='height:24;width:185px;float:left;'  id=\"form_textbox_input\" value='"+name+"'/>"
						html+="</div>";
						html+="<div class=\"form_textbox_input\">";							
...
function newBox1(title,name,serviceName,image,titleSName,titleName,titleIma,ok,cancel,url,address_)
{
	var my=this;
	this.show=function()
	{		
			...
			html+="<div class=\"form_textbox_subject\"><div class='div_title_form_new_src' style='background-color:#D3D0BE'>"+title+"</div></div>";
				...
				html+="<div class='form_textbox_center'>";							
					html+="<div class='left_textbox'>";	
						...
						html+="<div class='div_name_input'>"+titleName+":</div>";						
							html+="<input type=\"text\"   style='border: 1px solid #dddddd;height:24;width:185px;float:left;'  id=\"form_textbox_input\" value='"+serviceName+"'/>";
						html+="</div>";
						
						html+="<div class=\"form_textbox_input\" style='margin-top: 10px;'>";				
						html+="<div class='div_name_input'>"+url+":</div>";					
							html+="<input type=\"text\"   style='border: 1px solid #dddddd;height:24;width:185px;float:left;'  id=\"url_address\" value='"+address_+"'/>";
						html+="</div>";
				...
				html+="<div class='form_1'>";
					//loai bo nut ok vi khong can thiet vi ko the hieu chinh tung livetv 18.1
					html+="<input type=\"button\" margin-left: 15px;' value='"+ok+"'  class='div_buton'id=\"form_textbox_ok\" >"
					html+="<input type=\"button\" value='"+cancel+"'  class='div_buton' id=\"form_textbox_cancel\">"
					html+="</div>"
				html+="</div>"
