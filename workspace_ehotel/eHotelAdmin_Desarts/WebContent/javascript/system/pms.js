	...
	this.show=function()
	{
		...
		html+="<div class='div_Title_detail' >"+title+"</div>";
				html+="<div class='form_textbox_center' style='width: 100%;'>";
					...
					html+="<input type=\"text\" size='26' style='border: 1px solid #dddddd;height:24;float:left;width:220;margin-top: 5px;'  id=\"form_textbox_input\" value='"+index+"'/>";
				html+="</div>";
					html+="<div class='pms_textbox_input'>";
						html+="<div class='pms_name_input'>"+langpms.image+":</div>";
						html+="<div style='float:left;width:220;height: 25px;margin-top: 8px;'>";
...
function ItemHotel1(id,name,view,action,status,portlog)
{
	this.Id=id;
	this.Name=name;
	this.View=view;
...
function ItemHotel(id,name,action,status)
{
	this.Id=id;
	this.Name=name;
	this.Action=action;
