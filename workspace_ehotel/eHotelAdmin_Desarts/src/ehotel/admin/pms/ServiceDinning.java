	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 1:// insert new subject
		{
			...
			if (request.getParameter("name") != null) {
				...
				pmsServiceDBI.updateIndexMenuDining(id, index);
				if (id > 0) {
		...
		case 2:// update
		{
			...
			if (request.getParameter("index") != null) {
				index = request.getParameter("index").toString().trim();
			}
			if (request.getParameter("name") != null) {
				subjectName = request.getParameter("name").toString();
				...
				t = pmsServiceDBI.updateIndexMenuDining(id, index);
				/**
				 * copy
				 */
				if (t) {
