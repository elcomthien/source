...
public class PMSMainMenu {
	...
	public String toString() {
		return "PMSMainMenu [menuid=" + menuid + ", menuname=" + menuname + ", menuimage=" + menuimage + ", menubackground="
				+ menubackground + ", menurvcserviceid=" + menurvcserviceid + ", menutype=" + menutype + ", menuinvisible=" + menuinvisible
				+ "]";
	}
