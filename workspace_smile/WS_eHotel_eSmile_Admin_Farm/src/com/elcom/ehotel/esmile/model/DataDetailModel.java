...
public class DataDetailModel {
	...
	public String toString() {
		return "DataDetailModel [store_id=" + store_id + ", store_name=" + store_name + ", employee_id=" + employee_id + ", employee_name="
				+ employee_name + ", smile_id=" + smile_id + ", smile_name=" + smile_name + ", rating=" + rating + ", date=" + date + "]";
	}
	...
	public DataDetailModel(String store_id, String store_name, String employee_id, String employee_name, String smile_id,
