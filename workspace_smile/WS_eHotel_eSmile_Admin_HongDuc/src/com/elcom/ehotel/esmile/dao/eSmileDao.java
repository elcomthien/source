...
public class eSmileDao {
	...
	public List<HashMap<String, String>> getListComment(String from, String to, String listlocation) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_COMMENT, params, "from,to,listlocation", outParam.size() / 4);
		for (int i = 0; i < outParam.size(); i = i + 4) {
	...
	public List<RatingModel> getRatingDivisionType(String from, String to, String listlocation, String langid, String type) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_DIVISION, params, "from,to,listlocation,langid,type", outParam.size() / 4);
		for (int i = 0; i < outParam.size(); i = i + 4) {
			RatingModel rate = new RatingModel();
			rate.setId(outParam.get(i));
			rate.setName(outParam.get(i + 1));
	...
	@SuppressWarnings("unchecked")
	public List<RatingModel> getRatingType(String sid, String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_SMILE, params, "sid,langid", outParam.size() / 3);
		for (int i = 0; i < outParam.size(); i += 3) {
	...
	public static void main(String[] args) {
		...
		// System.out.println(e.getRatingAll("01-05-2017", "03-05-2017", "1,2", "2"));
