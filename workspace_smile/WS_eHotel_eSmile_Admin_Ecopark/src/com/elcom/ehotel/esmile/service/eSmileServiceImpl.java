...
public class eSmileServiceImpl implements eSmileService {
	...
	public String addItemDining(String object) {
		...
		map = Util.convertObject(object, "");
		// object:
		// {"image":"food-1497255202453.jpg","detail":"test add food detail","price":"50000","unit":"VND"}
	...
	public String getRatingType(String object) {
		...
		list = eSmileDao.getRatingType(id, langid, fid);
		System.out.println("result: " + list);
		return new Gson().toJson(list);
	}
	...
	@Override
	public String getListAccount(String object) {
		System.out.println("------>getListAccount");
		System.out.println("object: " + object);
		List<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
		list = eSmileDao.getListAccount();
		System.out.println("result: " + list);
		return new Gson().toJson(list);
	}

	@Override
	public String getAccountById(String object) {
		...
		map = eSmileDao.getListAccountById(userid);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String addAccount(String object) {
		...
		pass = Encryptor.encryptPassword(pass);
		map = eSmileDao.addAccount(username, pass, fullname, roleid, avatar);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String editAccount(String object) {
		...
		if (pass.equals(""))
			...
			pass = Encryptor.encryptPassword(pass);
		map = eSmileDao.editAccount(userid, pass, fullname, status, roleid, avatar);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String deleteAccount(String object) {
		...
		map = Util.convertObject(object, "");
		String userid = map.get("userid");
		map = eSmileDao.deleteAccount(userid);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String getListRole(String object) {
		System.out.println("------>getListRole");
		System.out.println("object: " + object);
		List<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
		list = eSmileDao.getListRole();
		System.out.println("result: " + list);
		return new Gson().toJson(list);
	}

	@Override
	public String addRole(String object) {
		...
		map = eSmileDao.addRole(rolename, permission);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String editRole(String object) {
		...
		String rolename = map.get("rolename");
		String permission = map.get("permission");
		map = eSmileDao.editRole(roleid, rolename, permission);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}

	@Override
	public String deleteRole(String object) {
		...
		map = Util.convertObject(object, "");
		String roleid = map.get("roleid");
		map = eSmileDao.deleteRole(roleid);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}
	...
	public String changePassword(String object) {
		...
		map = Util.convertObject(object, "");
		String username = map.get("username");
		String currentpass = map.get("currentpass");
		String newpass = map.get("newpass");
		String fullname = map.get("fullname");
		String avatar = map.get("avatar");
		if (currentpass.equals(""))
			currentpass = "No change";
		else
			currentpass = Encryptor.encryptPassword(currentpass);
		newpass = Encryptor.encryptPassword(newpass);
		map = eSmileDao.changePassword(username, currentpass, newpass, fullname, avatar);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}
	
	@Override
	public String addRating(String object) {
		...
		String name = map.get("name");
		String image = map.get("image");
		map = eSmileDao.addRating(smileid, name, image);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}
	
	@Override
	public String deleteRating(String object) {
		...
		map = Util.convertObject(object, "");
		String ratingid = map.get("id");
		map = eSmileDao.deleteRating(ratingid);
		System.out.println("result: " + map);
		return new Gson().toJson(map);
	}
