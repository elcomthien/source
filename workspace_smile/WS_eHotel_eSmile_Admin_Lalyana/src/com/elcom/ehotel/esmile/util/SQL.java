...
public class SQL {
	...
	public static final String GET_VOTE_SURVEY_NEW = "BEGIN EADMIN.getVoteSurveyNew(?,?,?,?,?); END;";
	
	public static final String GET_EMAIL = "BEGIN EADMIN.getListEmail(?); END;";
	
	public static final String GET_COMMENT_NEW = "BEGIN EADMIN.getComment(?,?,?,?); END;";
}
