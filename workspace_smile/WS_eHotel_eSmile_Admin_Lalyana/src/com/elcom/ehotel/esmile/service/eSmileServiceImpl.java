...
public class eSmileServiceImpl implements eSmileService {
	...
	public String getVoteSurvey(String object) {
		...
		String listlocation = map.get("location");
		String langid = map.get("lang_id");
		list = eSmileDao.getVoteSurveyNew(from, to, listlocation, langid);
		System.out.println("result: " + list);
		return new Gson().toJson(list);
	}
	
	@Override
	public String getVoteSurveyNew(String object) {
		System.out.println("------>getVoteSurveyNew");
		System.out.println("object: " + object);
		HashMap<String, String> map = new HashMap<String, String>();
		if (!Util.checkObject(object)) {
			map = Util.noneParam();
	...
	@Override
	public String getComment(String object) {
		...
		String from = map.get("date_from");
		String to = map.get("date_to");
		String listroom = map.get("location");
		list = eSmileDao.getComment(from, to, listroom);
		System.out.println("result: " + list);
		return new Gson().toJson(list);
	}
}
