...
public class InfoModel {
	...
	List<ObjFaculty> arrdepartment;

	public InfoModel(String logo, List<ObjLang> arrlang, List<ObjSmile> arrsmile, List<ObjRating> arrrating, List<ObjWelcome> arrwelcome,
			List<String> arrbackground, List<ObjPromotion> arrpromotion, List<ObjFaculty> arrdepartment) {
		this.logo = logo;
	...
	public String toString() {
		return "InfoModel [logo=" + logo + ", arrlang=" + arrlang + ", arrsmile=" + arrsmile + ", arrrating=" + arrrating + ", arrwelcome="
				+ arrwelcome + ", arrbackground=" + arrbackground + ", arrpromotion=" + arrpromotion + ", arrdepartment=" + arrdepartment
				+ "]";
	}
	...
	public List<ObjFaculty> getArrdepartment() {
		return arrdepartment;
	}

	public void setArrdepartment(List<ObjFaculty> arrdepartment) {
		this.arrdepartment = arrdepartment;
	}
