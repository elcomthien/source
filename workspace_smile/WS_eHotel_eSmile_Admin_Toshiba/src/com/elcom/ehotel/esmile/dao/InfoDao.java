...
public class InfoDao {
	...
	@SuppressWarnings("unchecked")
	public List<SubjectInfoModel> getSubjectInfo(String langid, String type) {
		...
		LogUtil.logDao(InfoDao.class.toString(), SQL.GET_SUBJECT_INFO, params, "langid,type", outParam.size() / 5);
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> addSubjectInfo(String name, String image, String type) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.ADD_SUBJECT_INFO, params, "name,image,type", rs);
	...
	public List<HashMap<String, String>> getService(String langid) {
		...
		LogUtil.logDao(InfoDao.class.toString(), SQL.GET_SERVICE, params, "langid", outParam.size() / 7);
