...
public class eSmileDao {
	...
	public HashMap<String, String> getLogin(String username, String password) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_LOGIN, params,
				"uaername,password", outParam.size());
		return hm;
	}
	...
	public List<LocationModel> getLocation(String id) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_LOCATION, params,
				"id", outParam.size() / 6);
	...
	public List<ConfigModel> getBackground() {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_BACKGROUND, params,
				"none", outParam.size() / 5);
	...
	public HashMap<String, String> deleteBackground(String id) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.DELETE_BACKGROUND,
				params, "id", rs);
	...
	public HashMap<String, String> editBackground(String id, String value) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_BACKGROUND, params,
				"id,value", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	public HashMap<String, String> addBackground(String value) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.ADD_BACKGROUND, params,
				"value", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	@SuppressWarnings("unchecked")
	public List<StatisticModel> getStatistic(String from, String to,
			String listlocation) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_STATISTIC, params,
				"from,to,listlocation", outParam.size() / 6);
		for (int i = 0; i < outParam.size(); i = i + 6) {
	...
	@SuppressWarnings("unchecked")
	public List<RatingModel> getRating(String from, String to,
			String listlocation, String smileid, String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING, params,
				"from,to,listlocation,smileid,langid", outParam.size() / 3);
	...
	@SuppressWarnings("unchecked")
	public List<RatingModel> getRating6(String from, String to,
			String listlocation, String smileid, String langid) {
		List<RatingModel> list = new ArrayList<RatingModel>();
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(from), 0);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_6, params,
				"from,to,listlocation,smileid,langid", outParam.size() / 4);
	...
	@SuppressWarnings("unchecked")
	public List<SmileModel> getSmile(String from, String to,
			String listlocation, String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_SMILE, params,
				"from,to,listlocation,langid", outParam.size() / 6);
		for (int i = 0; i < outParam.size(); i = i + 6) {
	...
	public List<PromotionModel> getPromotion() {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_PROMOTION, params,
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> addPromotion(String name, String url,
			String image) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.ADD_PROMOTION, params,
				"name,url,image", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editPromotion(String id, String name,
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_PROMOTION, params,
				"id,name,url,image", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
			hm.put("message", "OK");
	...
	public HashMap<String, String> deletePromotion(String id) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.DELETE_PROMOTION,
				params, "id", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	public List<AllRatingModel> getAllRating(String from, String to,
			String listlocation, String langid) {
		...
		for (int i = 0; i < listsmile.size(); i++) {
			...
			if (arm.getSmile_id().equals("6")) {
				...
				listrate = getRating(from, to, listlocation, arm.getSmile_id(),
						langid);
	...
	@SuppressWarnings("unchecked")
	public List<HashMap<String, String>> getListComment(String from, String to,
			String listlocation) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_COMMENT, params,
				"from,to,listlocation", outParam.size() / 7);
	...
	@SuppressWarnings("unchecked")
	public List<RatingModel> getRatingDivisionType(String from, String to,
			String listlocation, String langid, String type) {
		List<RatingModel> list = new ArrayList<RatingModel>();
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(from), 0);
		params.add(in);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_DIVISION,
				params, "from,to,listlocation,langid,type", outParam.size() / 7);
	...
	public RatingDivisionModel getRatingDivision(String from, String to,
			String listlocation, String langid) {
	...
	public SurveyModel getListSurvey(String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_SURVEY, params,
				"langid", outParam.size());
	...
	public HashMap<String, String> addSurvey(String name, String image) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.ADD_SURVEY, params,
				"name,image", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editSurvey(String id, String name,
			String image, String status, String langid) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(id), 0);
		params.add(in);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_SURVEY, params,
				"id,name,image,status,langid", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
			hm.put("message", "OK");
	...
	public HashMap<String, String> deleteSurvey(String id) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.DELETE_SURVEY, params,
				"id", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	public List<HashMap<String, String>> getListRoom() {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_ROOM, params,
				"none", outParam.size());
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editSmile(String id, String name,
			String image, String langid, String type) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(id), 0);
		params.add(in);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_SMILE, params,
				"id,name,image,langid,type", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
			hm.put("message", "OK");
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editRating(String id, String name,
			String image, String langid, String type) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(id), 0);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_RATING, params,
				"id,name,image,langid,type", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	@SuppressWarnings("unchecked")
	public List<RatingSurveyModel> getVoteSurvey(String from, String to,
			String listroom, String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_RATING, params,
				"from,to,listroom,langid", outParam.size() / 7);
		for (int i = 0; i < outParam.size(); i = i + 7) {
	...
	public List<SmileModel> getSmileFaculty(String fid, String langid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_SMILE_FACULTY,
				params, "fid,langid", outParam.size() / 3);
		for (int i = 0; i < outParam.size(); i += 3) {
			SmileModel smile = new SmileModel(outParam.get(i),
					outParam.get(i + 1), outParam.get(i + 2));
			list.add(smile);
		}
		return list;
	}
	...
	public List<RatingModel> getRatingType(String sid, String langid, String fid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_SMILE,
				params, "sid,langid,fid", outParam.size() / 3);
		for (int i = 0; i < outParam.size(); i += 3) {
			RatingModel rating = new RatingModel(outParam.get(i),
					outParam.get(i + 1), outParam.get(i + 2));
			list.add(rating);
		}
		return list;
	...
	@SuppressWarnings("unchecked")
	public List<SmileModel> getRatingAll(String from, String to,
			String listlocation, String langid) {
		List<SmileModel> list = new ArrayList<SmileModel>();
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(from), 0);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_RATING_ALL, params,
				"from,to,listlocation,langid", outParam.size());
		for (int i = 0; i < outParam.size(); i = i + 5) {
			SmileModel smile = new SmileModel();
			smile.setId(outParam.get(i));
			smile.setName(outParam.get(i + 1));
			...
			if (count > 0) {
				...
				for (int j = i + 5; j < length; j += 4) {
					RatingModel rate = new RatingModel(outParam.get(j),
							outParam.get(j + 1), outParam.get(j + 2),
							outParam.get(j + 3));
					listrate.add(rate);
				}
				i = length - 5;
	...
	public Map<String, Object> getInfoSurvey(String langid, String status) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.GET_INFO_SURVEY, params,
				"langid,status", outParam.size());
	...
	public int postSurvey(String rid, String sid) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.POST_SURVEY, params,
				"rid,sid", rs);
		return rs;
	}

	public HashMap<String, String> postSurveyService(String listcontent,
			String listsmile) {
		int rs = 1;
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editSmileSurvey(String id, String name,
			String image, String langid) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(id), 0);
		params.add(in);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_SMILE_SURVEY,
				params, "id,name,image,langid", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
			hm.put("message", "OK");
	...
	public HashMap<String, String> addRatingSurvey(String name) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.ADD_RATING_SURVEY,
				params, "name", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	@SuppressWarnings("unchecked")
	public HashMap<String, String> editRatingSurvey(String id, String name,
			String index, String status, String langid) {
		int rs = -1;
		Vector<SubProParam> params = new Vector<SubProParam>();
		SubProParam in = new SubProParam(new String(id), 0);
		params.add(in);
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.EDIT_RATING_SURVEY,
				params, "id,name,index,status,langid", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
			hm.put("message", "OK");
	...
	public HashMap<String, String> deleteRatingSurvey(String id) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.DELETE_RATING_SURVEY,
				params, "id", rs);
		HashMap<String, String> hm = new HashMap<String, String>();
		hm.put("status", String.valueOf(rs));
		if (rs == 1)
	...
	public String countFaculty(String listlocation) {
		...
		LogUtil.logDao(eSmileDao.class.toString(), SQL.COUNT_FACULTY, params,
				"listlocation", 1);
		return rs;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(e.getInfoSurvey("1", "1"));
	}
}
