...
public class ObjNotify {
	...
	public ObjNotify(String id, String folio, String guest, String name, String time, String location, String status) {
		this.id = id;
		this.name = name == null ? "" : name;
		this.status = status == null ? "" : status;
		this.time = time == null ? "" : time;
	...
	public String toString() {
		return "ObjNotify [id=" + id + ", name=" + name + ", status=" + status + ", time=" + time + ", location=" + location + ", folio="
				+ folio + ", guest=" + guest + ", checkin=" + checkin + ", checkout=" + checkout + "]";
	}
