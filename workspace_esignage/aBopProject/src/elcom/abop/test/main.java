		...
		try {
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					System.out.println("font : " + eElement.getElementsByTagName("font").item(0).getTextContent());
					System.out.println("fontsize : " + eElement.getElementsByTagName("fontsize").item(0).getTextContent());
